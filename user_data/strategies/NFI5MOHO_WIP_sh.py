...
class NFI5MOHO_WIP_sh(IStrategy):
    ...
    base_nb_candles_buy = IntParameter(
        5, 80, default=20, load=True, space="buy", optimize=sh.get_space("ma")
    )

    base_nb_candles_sell = IntParameter(
        5, 80, default=20, load=True, space="sell", optimize=sh.get_space("ma")
    )

    low_offset_sma = DecimalParameter(
        0.9, 0.99, default=0.958, load=True, space="buy", optimize=sh.get_space("sma")
    )

    high_offset_sma = DecimalParameter(
        0.99, 1.1, default=1.012, load=True, space="sell", optimize=sh.get_space("sma")
    )

    low_offset_ema = DecimalParameter(
        0.9, 0.99, default=0.958, load=True, space="buy", optimize=sh.get_space("ema")
    )

    high_offset_ema = DecimalParameter(
        0.99, 1.1, default=1.012, load=True, space="sell", optimize=sh.get_space("ema")
    )

    low_offset_trima = DecimalParameter(
        0.9, 0.99, default=0.958, load=True, space="buy", optimize=sh.get_space("trima")
    )
    ...
    high_offset_trima = DecimalParameter(
        ...
        load=True,
        space="sell",
        optimize=sh.get_space("trima"),
    )

    low_offset_t3 = DecimalParameter(
        0.9, 0.99, default=0.958, load=True, space="buy", optimize=sh.get_space("t3")
    )

    high_offset_t3 = DecimalParameter(
        0.99, 1.1, default=1.012, load=True, space="sell", optimize=sh.get_space("t3")
    )

    low_offset_kama = DecimalParameter(
        0.9, 0.99, default=0.958, load=True, space="buy", optimize=sh.get_space("kama")
    )

    high_offset_kama = DecimalParameter(
        0.99, 1.1, default=1.012, load=True, space="sell", optimize=sh.get_space("kama")
    )

    # Protection

    ewo_low = DecimalParameter(
        -20.0, -8.0, default=-20.0, load=True, space="buy", optimize=sh.get_space("ewo")
    )

    ewo_high = DecimalParameter(
        2.0, 12.0, default=6.0, load=True, space="buy", optimize=sh.get_space("ewo")
    )

    fast_ewo = IntParameter(
        10, 50, default=50, load=True, space="buy", optimize=sh.get_space("ewo")
    )

    slow_ewo = IntParameter(
        100, 200, default=200, load=True, space="buy", optimize=sh.get_space("ewo")
    )
    ...
    buy_condition_1_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition1"),
        load=True,
    )
    ...
    buy_condition_2_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition2"),
        load=True,
    )
    ...
    buy_condition_3_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition3"),
        load=True,
    )
    ...
    buy_condition_4_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition4"),
        load=True,
    )
    ...
    buy_condition_5_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition5"),
        load=True,
    )
    ...
    buy_condition_6_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition6"),
        load=True,
    )
    ...
    buy_condition_7_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition7"),
        load=True,
    )
    ...
    buy_condition_8_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition8"),
        load=True,
    )
    ...
    buy_condition_9_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition9"),
        load=True,
    )
    ...
    buy_condition_10_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition10"),
        load=True,
    )
    ...
    buy_condition_11_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition11"),
        load=True,
    )
    ...
    buy_condition_12_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition12"),
        load=True,
    )
    ...
    buy_condition_13_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition13"),
        load=True,
    )
    ...
    buy_condition_14_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition14"),
        load=True,
    )
    ...
    buy_condition_15_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition15"),
        load=True,
    )
    ...
    buy_condition_16_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition16"),
        load=True,
    )
    ...
    buy_condition_17_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition17"),
        load=True,
    )
    ...
    buy_condition_18_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition18"),
        load=True,
    )
    ...
    buy_condition_19_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition19"),
        load=True,
    )
    ...
    buy_condition_20_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition20"),
        load=True,
    )
    ...
    buy_condition_21_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_condition21"),
        load=True,
    )
    ...
    #  buy_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.988, space='buy', decimals=3, optimize=sh.get_space('buy_condition20'), load=True)
    ...
    #  buy_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.988, space='buy', decimals=3, optimize=sh.get_space('buy_condition21'), load=True)
    ...
    sell_condition_1_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition1"),
        load=True,
    )
    ...
    sell_condition_2_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition2"),
        load=True,
    )
    ...
    sell_condition_3_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition3"),
        load=True,
    )
    ...
    sell_condition_4_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition4"),
        load=True,
    )
    ...
    sell_condition_5_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition5"),
        load=True,
    )
    ...
    sell_condition_6_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition6"),
        load=True,
    )
    ...
    sell_condition_7_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition7"),
        load=True,
    )
    ...
    sell_condition_8_enable = CategoricalParameter(
        ...
        default=True,
        space="sell",
        optimize=sh.get_space("sell_condition8"),
        load=True,
    )
    ...
    sell_custom_profit_0 = DecimalParameter(
        ...
        space="sell",
        decimals=3,
        optimize=sh.get_space("sell_condition0"),
        load=True,
    )
