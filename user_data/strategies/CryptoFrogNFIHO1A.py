...
class CryptoFrogNFIHO1A(IStrategy):
    ...
    droi_pullback = CategoricalParameter(
    ...
    droi_pullback_respect_table = CategoricalParameter(
    ...
    cstp_bail_how = CategoricalParameter(
        ["roc", "time", "any"], default="roc", space="sell", optimize=True
    )
    ...
    buy_01_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="26", space="buy", optimize=True, load=True
    )
    buy_01_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_01_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_01_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_01_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_01_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="36",
        space="buy",
        optimize=True,
    ...
    buy_01_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_01_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_01_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_01_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_01_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_01_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=True, load=True
    )

    buy_condition_2_enable = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_02_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_02_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_02_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_02_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_02_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_02_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_02_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_02_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    buy_02_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_02_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_02_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_02_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_03_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_03_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_03_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_03_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_03_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_03_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_03_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_03_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_03_protection__safe_dips = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_03_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_03_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_03_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_03_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=True, load=True
    )
    buy_03_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_03_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_03_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_03_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_04_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_04_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_04_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_04_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_04_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_04_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_04_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_04_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_04_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_04_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_04_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_04_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_04_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="48", space="buy", optimize=True, load=True
    )
    buy_04_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_04_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_04_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_04_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="20",
        space="buy",
        optimize=True,
    ...
    buy_05_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_05_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="100",
        space="buy",
        optimize=True,
    ...
    buy_05_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_05_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_05_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_05_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_05_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_05_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_05_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_05_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_05_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_05_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_05_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=True, load=True
    )
    buy_05_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_05_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_05_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_05_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_06_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_06_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_06_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_06_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_06_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_06_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_06_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_06_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_06_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_06_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_06_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_06_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=True, load=True
    )
    ...
    buy_07_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_07_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_07_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_07_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_07_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_07_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_07_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_07_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_07_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_07_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_07_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_07_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_07_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_07_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_07_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_07_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_07_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_08_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_08_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_08_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_08_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_08_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_08_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_08_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_08_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_08_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_08_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_08_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_08_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_08_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_08_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_08_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_08_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_08_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_09_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_09_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_09_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_09_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_09_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_09_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_09_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_09_protection__safe_dips = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_09_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_09_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_09_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_10_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_10_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_10_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_10_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_10_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_10_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_10_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="24",
        space="buy",
        optimize=True,
    ...
    buy_10_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_10_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_10_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_10_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_10_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_11_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_11_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_11_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_11_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_11_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_11_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_11_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_11_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_11_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_11_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_11_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_11_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_12_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_12_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_12_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_12_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_12_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_12_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_12_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="24",
        space="buy",
        optimize=True,
    ...
    buy_12_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_12_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_12_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_12_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_12_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_13_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_13_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_13_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_13_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_13_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_13_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_13_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="24",
        space="buy",
        optimize=True,
    ...
    buy_13_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_13_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_13_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_13_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_13_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_14_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_14_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_14_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_14_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_14_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_14_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_14_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_14_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_14_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_14_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="30",
        space="buy",
        optimize=True,
    ...
    buy_14_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_14_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_14_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_14_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_14_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_14_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_14_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_15_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_15_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_15_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_15_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_15_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_15_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_15_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_15_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_15_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_15_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_15_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_15_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_15_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_15_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_15_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_15_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_15_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=True, load=True
    )
    ...
    buy_16_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_16_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_16_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_16_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_16_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_16_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_16_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_16_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_16_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_16_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_16_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_16_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_16_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_16_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_16_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_16_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_16_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_17_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_17_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_17_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_17_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_17_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_17_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_17_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_17_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_17_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_17_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_17_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_17_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_18_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_18_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_18_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_18_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_18_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_18_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="44",
        space="buy",
        optimize=True,
    ...
    buy_18_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="72",
        space="buy",
        optimize=True,
    ...
    buy_18_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_18_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_18_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_18_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_19_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_19_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_19_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_19_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="100", space="buy", optimize=True, load=True
    )
    buy_19_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_19_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_19_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_19_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_19_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_19_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="36",
        space="buy",
        optimize=True,
    ...
    buy_19_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_19_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_19_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_19_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_19_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_19_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_19_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_20_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_20_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_20_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_20_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_20_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_20_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_20_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_20_protection__safe_dips = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_20_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_20_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_20_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )
    ...
    buy_21_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_21_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_21_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_21_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_21_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_21_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_21_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_21_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_21_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_21_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_21_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_21_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )

    buy_condition_22_enable = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_22_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_22_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_22_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_22_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_22_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_22_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_22_protection__safe_dips = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_22_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_22_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_22_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )

    buy_condition_23_enable = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_23_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_23_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_23_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_23_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_23_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_23_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_23_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_23_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_23_protection__sma200_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_23_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_23_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_23_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=True,
    ...
    buy_23_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_23_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="loose",
        space="buy",
        optimize=True,
    ...
    buy_23_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_23_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_23_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )

    buy_condition_24_enable = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_24_protection__ema_fast = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_24_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_24_protection__ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_24_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="50", space="buy", optimize=True, load=True
    )
    buy_24_protection__close_above_ema_fast = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_24_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="200",
        space="buy",
        optimize=True,
    ...
    buy_24_protection__close_above_ema_slow = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_24_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=True, load=True
    )
    buy_24_protection__sma200_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_24_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="30",
        space="buy",
        optimize=True,
    ...
    buy_24_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_24_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="36",
        space="buy",
        optimize=True,
    ...
    buy_24_protection__safe_dips = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=True, load=True
    )
    buy_24_protection__safe_dips_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="strict",
        space="buy",
        optimize=True,
    ...
    buy_24_protection__safe_pump = CategoricalParameter(
        [True, False], default=False, space="buy", optimize=True, load=True
    )
    buy_24_protection__safe_pump_type = CategoricalParameter(
        ["strict", "normal", "loose"],
        default="normal",
        space="buy",
        optimize=True,
    ...
    buy_24_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=True, load=True
    )

    # Normal dips
    buy_dip_threshold_1 = DecimalParameter(
        0.001, 0.05, default=0.02, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_2 = DecimalParameter(
        0.01, 0.2, default=0.14, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_3 = DecimalParameter(
        0.05, 0.4, default=0.32, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_4 = DecimalParameter(
        0.2, 0.5, default=0.5, space="buy", decimals=3, optimize=True, load=True
    )
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(
        0.001, 0.05, default=0.015, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_6 = DecimalParameter(
        0.01, 0.2, default=0.1, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_7 = DecimalParameter(
        0.05, 0.4, default=0.24, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_8 = DecimalParameter(
        0.2, 0.5, default=0.42, space="buy", decimals=3, optimize=True, load=True
    )
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(
        0.001, 0.05, default=0.026, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_10 = DecimalParameter(
        0.01, 0.2, default=0.24, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_11 = DecimalParameter(
        0.05, 0.4, default=0.42, space="buy", decimals=3, optimize=True, load=True
    )
    buy_dip_threshold_12 = DecimalParameter(
        0.2, 0.5, default=0.8, space="buy", decimals=3, optimize=True, load=True
    )

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(
        1.5, 3.0, default=1.75, space="buy", decimals=2, optimize=True, load=True
    )
    buy_pump_threshold_1 = DecimalParameter(
        0.4, 1.0, default=0.6, space="buy", decimals=3, optimize=True, load=True
    )
    # 36 hours
    ...
    buy_pump_threshold_2 = DecimalParameter(
        0.4, 1.0, default=0.64, space="buy", decimals=3, optimize=True, load=True
    )
    # 48 hours
    ...
    buy_pump_threshold_3 = DecimalParameter(
        0.4, 1.0, default=0.85, space="buy", decimals=3, optimize=True, load=True
    )

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(
        1.5, 3.0, default=2.2, space="buy", decimals=2, optimize=True, load=True
    )
    buy_pump_threshold_4 = DecimalParameter(
        0.4, 1.0, default=0.42, space="buy", decimals=3, optimize=True, load=True
    )
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(
        1.5, 3.0, default=2.0, space="buy", decimals=2, optimize=True, load=True
    )
    buy_pump_threshold_5 = DecimalParameter(
        0.4, 1.0, default=0.58, space="buy", decimals=3, optimize=True, load=True
    )
    # 48 hours strict
    ...
    buy_pump_threshold_6 = DecimalParameter(
        0.4, 1.0, default=0.8, space="buy", decimals=3, optimize=True, load=True
    )

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(
        1.5, 3.0, default=1.7, space="buy", decimals=2, optimize=True, load=True
    )
    buy_pump_threshold_7 = DecimalParameter(
        0.4, 1.0, default=0.66, space="buy", decimals=3, optimize=True, load=True
    )
    # 36 hours loose
    ...
    buy_pump_threshold_8 = DecimalParameter(
        0.4, 1.0, default=0.7, space="buy", decimals=3, optimize=True, load=True
    )
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(
        1.3, 2.0, default=1.4, space="buy", decimals=2, optimize=True, load=True
    )
    buy_pump_threshold_9 = DecimalParameter(
        0.4, 1.8, default=1.6, space="buy", decimals=3, optimize=True, load=True
    )

    buy_min_inc_1 = DecimalParameter(
        0.01, 0.05, default=0.022, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_1h_min_1 = DecimalParameter(
        25.0, 40.0, default=30.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_1 = DecimalParameter(
        70.0, 90.0, default=84.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1 = DecimalParameter(
        20.0, 40.0, default=36.0, space="buy", decimals=1, optimize=True, load=True
    )
    ...
    buy_rsi_1h_min_2 = DecimalParameter(
        30.0, 40.0, default=32.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_2 = DecimalParameter(
        70.0, 95.0, default=84.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_diff_2 = DecimalParameter(
        30.0, 50.0, default=39.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_mfi_2 = DecimalParameter(
        30.0, 56.0, default=49.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_bb_offset_2 = DecimalParameter(
        0.97, 0.999, default=0.983, space="buy", decimals=3, optimize=True, load=True
    )

    buy_bb40_bbdelta_close_3 = DecimalParameter(
        0.005, 0.06, default=0.057, space="buy", optimize=True, load=True
    )
    buy_bb40_closedelta_close_3 = DecimalParameter(
        0.01, 0.03, default=0.023, space="buy", optimize=True, load=True
    )
    buy_bb40_tail_bbdelta_3 = DecimalParameter(
        0.15, 0.45, default=0.418, space="buy", optimize=True, load=True
    )
    buy_ema_rel_3 = DecimalParameter(
        0.97, 0.999, default=0.986, space="buy", decimals=3, optimize=True, load=True
    )

    buy_bb20_close_bblowerband_4 = DecimalParameter(
        0.96, 0.99, default=0.979, space="buy", optimize=True, load=True
    )
    buy_bb20_volume_4 = DecimalParameter(
        1.0, 20.0, default=10.0, space="buy", decimals=2, optimize=True, load=True
    )

    buy_ema_open_mult_5 = DecimalParameter(
        0.016, 0.03, default=0.018, space="buy", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_5 = DecimalParameter(
        0.98, 1.0, default=0.996, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ema_rel_5 = DecimalParameter(
        0.97, 0.999, default=0.982, space="buy", decimals=3, optimize=True, load=True
    )

    buy_ema_open_mult_6 = DecimalParameter(
        0.02, 0.03, default=0.024, space="buy", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_6 = DecimalParameter(
        0.98, 0.999, default=0.984, space="buy", decimals=3, optimize=True, load=True
    )

    buy_ema_open_mult_7 = DecimalParameter(
        0.02, 0.04, default=0.03, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_7 = DecimalParameter(
        24.0, 50.0, default=36.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_volume_8 = DecimalParameter(
        1.0, 6.0, default=2.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_8 = DecimalParameter(
        16.0, 30.0, default=20.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_tail_diff_8 = DecimalParameter(
        3.0, 10.0, default=3.5, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_9 = DecimalParameter(
        0.91, 0.94, default=0.922, space="buy", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_9 = DecimalParameter(
        0.96, 0.98, default=0.965, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_1h_min_9 = DecimalParameter(
        26.0, 40.0, default=30.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_9 = DecimalParameter(
        70.0, 90.0, default=88.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_mfi_9 = DecimalParameter(
        36.0, 56.0, default=50.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_10 = DecimalParameter(
        0.93, 0.97, default=0.948, space="buy", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_10 = DecimalParameter(
        0.97, 0.99, default=0.994, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_1h_10 = DecimalParameter(
        20.0, 40.0, default=37.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_11 = DecimalParameter(
        0.93, 0.99, default=0.939, space="buy", decimals=3, optimize=True, load=True
    )
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.01, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_1h_min_11 = DecimalParameter(
        40.0, 60.0, default=56.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_11 = DecimalParameter(
        70.0, 90.0, default=84.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_11 = DecimalParameter(
        34.0, 50.0, default=48.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_mfi_11 = DecimalParameter(
        30.0, 46.0, default=36.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_12 = DecimalParameter(
        0.93, 0.97, default=0.922, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_12 = DecimalParameter(
        26.0, 40.0, default=30.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_ewo_12 = DecimalParameter(
        1.0, 6.0, default=1.8, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_13 = DecimalParameter(
        0.93, 0.98, default=0.99, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-11.8, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ema_open_mult_14 = DecimalParameter(
        0.01, 0.03, default=0.014, space="buy", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_14 = DecimalParameter(
        0.98, 1.0, default=0.988, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ma_offset_14 = DecimalParameter(
        0.93, 0.99, default=0.98, space="buy", decimals=3, optimize=True, load=True
    )

    buy_ema_open_mult_15 = DecimalParameter(
        0.01, 0.03, default=0.018, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ma_offset_15 = DecimalParameter(
        0.93, 0.99, default=0.954, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_15 = DecimalParameter(
        20.0, 36.0, default=28.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_ema_rel_15 = DecimalParameter(
        0.97, 0.999, default=0.988, space="buy", decimals=3, optimize=True, load=True
    )

    buy_ma_offset_16 = DecimalParameter(
        0.93, 0.97, default=0.952, space="buy", decimals=3, optimize=True, load=True
    )
    buy_rsi_16 = DecimalParameter(
        26.0, 50.0, default=31.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_ewo_16 = DecimalParameter(
        2.0, 6.0, default=2.8, space="buy", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_17 = DecimalParameter(
        0.93, 0.98, default=0.952, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-12.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_rsi_18 = DecimalParameter(
        16.0, 32.0, default=26.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_bb_offset_18 = DecimalParameter(
        0.98, 1.0, default=0.982, space="buy", decimals=3, optimize=True, load=True
    )

    buy_rsi_1h_min_19 = DecimalParameter(
        40.0, 70.0, default=50.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_chop_min_19 = DecimalParameter(
        20.0, 60.0, default=24.1, space="buy", decimals=1, optimize=True, load=True
    )

    buy_rsi_20 = DecimalParameter(
        20.0, 36.0, default=27.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_20 = DecimalParameter(
        14.0, 30.0, default=20.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_rsi_21 = DecimalParameter(
        10.0, 28.0, default=23.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_21 = DecimalParameter(
        18.0, 40.0, default=24.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_volume_22 = DecimalParameter(
        0.5, 6.0, default=3.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_bb_offset_22 = DecimalParameter(
        0.98, 1.0, default=0.98, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ma_offset_22 = DecimalParameter(
        0.93, 0.98, default=0.94, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ewo_22 = DecimalParameter(
        2.0, 10.0, default=4.2, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_22 = DecimalParameter(
        26.0, 56.0, default=37.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_bb_offset_23 = DecimalParameter(
        0.97, 1.0, default=0.987, space="buy", decimals=3, optimize=True, load=True
    )
    buy_ewo_23 = DecimalParameter(
        2.0, 10.0, default=7.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_23 = DecimalParameter(
        20.0, 40.0, default=30.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_23 = DecimalParameter(
        60.0, 80.0, default=70.0, space="buy", decimals=1, optimize=True, load=True
    )

    buy_24_rsi_max = DecimalParameter(
        26.0, 60.0, default=60.0, space="buy", decimals=1, optimize=True, load=True
    )
    buy_24_rsi_1h_min = DecimalParameter(
        40.0, 90.0, default=66.9, space="buy", decimals=1, optimize=True, load=True
    )

    # Sell

    sell_condition_1_enable = CategoricalParameter(
        [True, False], default=True, space="sell", optimize=True, load=True
    )
    ...
    sell_rsi_bb_1 = DecimalParameter(
        60.0, 80.0, default=79.5, space="sell", decimals=1, optimize=True, load=True
    )

    sell_rsi_bb_2 = DecimalParameter(
        72.0, 90.0, default=81, space="sell", decimals=1, optimize=True, load=True
    )

    sell_rsi_main_3 = DecimalParameter(
        77.0, 90.0, default=82, space="sell", decimals=1, optimize=True, load=True
    )

    sell_dual_rsi_rsi_4 = DecimalParameter(
        72.0, 84.0, default=73.4, space="sell", decimals=1, optimize=True, load=True
    )
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(
        78.0, 92.0, default=79.6, space="sell", decimals=1, optimize=True, load=True
    )

    sell_ema_relative_5 = DecimalParameter(
        0.005, 0.05, default=0.024, space="sell", optimize=True, load=True
    )
    sell_rsi_diff_5 = DecimalParameter(
        0.0, 20.0, default=4.4, space="sell", optimize=True, load=True
    )

    sell_rsi_under_6 = DecimalParameter(
        72.0, 90.0, default=79.0, space="sell", decimals=1, optimize=True, load=True
    )

    sell_rsi_1h_7 = DecimalParameter(
        80.0, 95.0, default=81.7, space="sell", decimals=1, optimize=True, load=True
    )

    sell_bb_relative_8 = DecimalParameter(
        1.05, 1.3, default=1.1, space="sell", decimals=3, optimize=True, load=True
    )

    sell_custom_profit_0 = DecimalParameter(
        0.01, 0.1, default=0.01, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_0 = DecimalParameter(
        30.0, 40.0, default=33.0, space="sell", decimals=3, optimize=True, load=True
    )
    ...
    sell_custom_rsi_1 = DecimalParameter(
        30.0, 50.0, default=34.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_2 = DecimalParameter(
        0.01, 0.1, default=0.03, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_2 = DecimalParameter(
        30.0, 50.0, default=38.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_3 = DecimalParameter(
        0.01, 0.1, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_3 = DecimalParameter(
        30.0, 50.0, default=42.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_4 = DecimalParameter(
        0.01, 0.1, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_4 = DecimalParameter(
        35.0, 50.0, default=43.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_5 = DecimalParameter(
        0.01, 0.1, default=0.06, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_5 = DecimalParameter(
        35.0, 50.0, default=44.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_6 = DecimalParameter(
        0.01, 0.1, default=0.07, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_6 = DecimalParameter(
        38.0, 55.0, default=49.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_7 = DecimalParameter(
        0.01, 0.1, default=0.08, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_7 = DecimalParameter(
        40.0, 58.0, default=54.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_8 = DecimalParameter(
        0.06, 0.1, default=0.09, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_8 = DecimalParameter(
        40.0, 50.0, default=54.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_9 = DecimalParameter(
        0.05, 0.14, default=0.1, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_9 = DecimalParameter(
        40.0, 60.0, default=50.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_10 = DecimalParameter(
        0.1, 0.14, default=0.12, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_10 = DecimalParameter(
        38.0, 50.0, default=42.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_custom_profit_11 = DecimalParameter(
        0.16, 0.45, default=0.20, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_rsi_11 = DecimalParameter(
        28.0, 40.0, default=34.0, space="sell", decimals=2, optimize=True, load=True
    )

    # Profit under EMA200
    sell_custom_under_profit_0 = DecimalParameter(
        0.01, 0.4, default=0.01, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_0 = DecimalParameter(
        28.0, 40.0, default=33.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_1 = DecimalParameter(
        0.01, 0.10, default=0.02, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_1 = DecimalParameter(
        36.0, 60.0, default=56.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_2 = DecimalParameter(
        0.01, 0.10, default=0.03, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_2 = DecimalParameter(
        46.0, 66.0, default=57.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_3 = DecimalParameter(
        0.01, 0.10, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_3 = DecimalParameter(
        50.0, 68.0, default=58.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_4 = DecimalParameter(
        0.02, 0.1, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_4 = DecimalParameter(
        50.0, 68.0, default=59.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_5 = DecimalParameter(
        0.02, 0.1, default=0.06, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_5 = DecimalParameter(
        46.0, 62.0, default=58.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_6 = DecimalParameter(
        0.03, 0.1, default=0.07, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_6 = DecimalParameter(
        44.0, 60.0, default=56.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_7 = DecimalParameter(
        0.04, 0.1, default=0.08, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_7 = DecimalParameter(
        46.0, 60.0, default=54.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_8 = DecimalParameter(
        0.06, 0.12, default=0.09, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_8 = DecimalParameter(
        40.0, 58.0, default=50.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_9 = DecimalParameter(
        0.08, 0.14, default=0.1, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_9 = DecimalParameter(
        32.0, 48.0, default=44.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_10 = DecimalParameter(
        0.1, 0.16, default=0.12, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_10 = DecimalParameter(
        30.0, 50.0, default=42.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_under_profit_11 = DecimalParameter(
        0.16, 0.3, default=0.2, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_under_rsi_11 = DecimalParameter(
        24.0, 40.0, default=34.0, space="sell", decimals=1, optimize=True, load=True
    )

    # Profit targets for pumped pairs 48h 1
    sell_custom_pump_profit_1_1 = DecimalParameter(
        0.01, 0.03, default=0.01, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_rsi_1_1 = DecimalParameter(
        26.0, 40.0, default=34.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_pump_profit_1_2 = DecimalParameter(
        0.01, 0.6, default=0.02, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_rsi_1_2 = DecimalParameter(
        36.0, 50.0, default=40.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_pump_profit_1_3 = DecimalParameter(
        0.02, 0.10, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_rsi_1_3 = DecimalParameter(
        38.0, 50.0, default=42.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_pump_profit_1_4 = DecimalParameter(
        0.06, 0.12, default=0.1, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_rsi_1_4 = DecimalParameter(
        36.0, 48.0, default=42.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_custom_pump_profit_1_5 = DecimalParameter(
        0.14, 0.24, default=0.2, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_rsi_1_5 = DecimalParameter(
        20.0, 40.0, default=34.0, space="sell", decimals=1, optimize=True, load=True
    )
    ...
    sell_custom_pump_rsi_2_3 = DecimalParameter(
        38.0, 50.0, default=40.0, space="sell", decimals=1, optimize=True, load=True
    )
    ...
    sell_custom_pump_rsi_3_2 = DecimalParameter(
        34.0, 50.0, default=40.0, space="sell", decimals=1, optimize=True, load=True
    )
    ...
    sell_custom_dec_profit_min_1 = DecimalParameter(
        0.01, 0.10, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_dec_profit_max_1 = DecimalParameter(
        0.06, 0.16, default=0.12, space="sell", decimals=3, optimize=True, load=True
    )

    # Under EMA100
    sell_custom_dec_profit_min_2 = DecimalParameter(
        0.05, 0.12, default=0.07, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_dec_profit_max_2 = DecimalParameter(
        0.06, 0.2, default=0.16, space="sell", decimals=3, optimize=True, load=True
    )

    # Trail 1
    sell_trail_profit_min_1 = DecimalParameter(
        0.1, 0.2, default=0.16, space="sell", decimals=2, optimize=True, load=True
    )
    sell_trail_profit_max_1 = DecimalParameter(
        0.4, 0.7, default=0.6, space="sell", decimals=2, optimize=True, load=True
    )
    sell_trail_down_1 = DecimalParameter(
        0.01, 0.08, default=0.03, space="sell", decimals=3, optimize=True, load=True
    )
    sell_trail_rsi_min_1 = DecimalParameter(
        16.0, 36.0, default=20.0, space="sell", decimals=1, optimize=True, load=True
    )
    sell_trail_rsi_max_1 = DecimalParameter(
        30.0, 50.0, default=50.0, space="sell", decimals=1, optimize=True, load=True
    )

    # Trail 2
    sell_trail_profit_min_2 = DecimalParameter(
        0.08, 0.16, default=0.1, space="sell", decimals=3, optimize=True, load=True
    )
    ...
    sell_trail_down_2 = DecimalParameter(
        0.02, 0.08, default=0.03, space="sell", decimals=3, optimize=True, load=True
    )
    ...
    sell_trail_profit_min_3 = DecimalParameter(
        0.01, 0.12, default=0.06, space="sell", decimals=3, optimize=True, load=True
    )
    sell_trail_profit_max_3 = DecimalParameter(
        0.1, 0.3, default=0.2, space="sell", decimals=2, optimize=True, load=True
    )
    sell_trail_down_3 = DecimalParameter(
        0.01, 0.06, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )

    # Under & near EMA200, accept profit
    sell_custom_profit_under_rel_1 = DecimalParameter(
        0.01, 0.04, default=0.024, space="sell", optimize=True, load=True
    )
    ...
    sell_custom_stoploss_under_rel_1 = DecimalParameter(
        0.001, 0.02, default=0.004, space="sell", optimize=True, load=True
    )
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(
        0.0, 20.0, default=8.0, space="sell", optimize=True, load=True
    )

    # 48h for pump sell checks
    sell_pump_threshold_1 = DecimalParameter(
        0.5, 1.2, default=0.9, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_2 = DecimalParameter(
        0.4, 0.9, default=0.7, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_3 = DecimalParameter(
        0.3, 0.7, default=0.5, space="sell", decimals=2, optimize=True, load=True
    )

    # 36h for pump sell checks
    sell_pump_threshold_4 = DecimalParameter(
        0.5, 0.9, default=0.72, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_5 = DecimalParameter(
        3.0, 6.0, default=4.0, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_6 = DecimalParameter(
        0.8, 1.6, default=1.0, space="sell", decimals=2, optimize=True, load=True
    )

    # 24h for pump sell checks
    sell_pump_threshold_7 = DecimalParameter(
        0.5, 0.9, default=0.68, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_8 = DecimalParameter(
        0.3, 0.6, default=0.62, space="sell", decimals=2, optimize=True, load=True
    )
    sell_pump_threshold_9 = DecimalParameter(
        0.2, 0.5, default=0.3, space="sell", decimals=2, optimize=True, load=True
    )

    # Pumped, descending SMA
    sell_custom_pump_dec_profit_min_1 = DecimalParameter(
        0.001, 0.04, default=0.005, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_dec_profit_max_1 = DecimalParameter(
        0.03, 0.08, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_dec_profit_min_2 = DecimalParameter(
        0.01, 0.08, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_dec_profit_max_2 = DecimalParameter(
        0.04, 0.1, default=0.06, space="sell", decimals=3, optimize=True, load=True
    )
    ...
    sell_custom_pump_dec_profit_min_4 = DecimalParameter(
        0.01, 0.05, default=0.02, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_dec_profit_max_4 = DecimalParameter(
        0.02, 0.1, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )

    # Pumped 48h 1, under EMA200
    sell_custom_pump_under_profit_min_1 = DecimalParameter(
        0.02, 0.06, default=0.04, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_under_profit_max_1 = DecimalParameter(
        0.04, 0.1, default=0.09, space="sell", decimals=3, optimize=True, load=True
    )

    # Pumped trail 1
    sell_custom_pump_trail_profit_min_1 = DecimalParameter(
        0.01, 0.12, default=0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_pump_trail_profit_max_1 = DecimalParameter(
        0.06, 0.16, default=0.07, space="sell", decimals=2, optimize=True, load=True
    )
    ...
    sell_custom_pump_trail_rsi_max_1 = DecimalParameter(
        30.0, 50.0, default=70.0, space="sell", decimals=1, optimize=True, load=True
    )

    # Stoploss, pumped, 48h 1
    sell_custom_stoploss_pump_max_profit_1 = DecimalParameter(
        0.01, 0.04, default=0.025, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_min_1 = DecimalParameter(
        -0.1, -0.01, default=-0.02, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_max_1 = DecimalParameter(
        -0.1, -0.01, default=-0.01, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_ma_offset_1 = DecimalParameter(
        0.7, 0.99, default=0.94, space="sell", decimals=2, optimize=True, load=True
    )
    ...
    sell_custom_stoploss_pump_loss_2 = DecimalParameter(
        -0.1, -0.01, default=-0.05, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_ma_offset_2 = DecimalParameter(
        0.7, 0.99, default=0.92, space="sell", decimals=2, optimize=True, load=True
    )

    # Stoploss, pumped, 36h 3
    sell_custom_stoploss_pump_max_profit_3 = DecimalParameter(
        0.01, 0.04, default=0.008, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_loss_3 = DecimalParameter(
        -0.16, -0.06, default=-0.12, space="sell", decimals=3, optimize=True, load=True
    )
    sell_custom_stoploss_pump_ma_offset_3 = DecimalParameter(
        0.7, 0.99, default=0.88, space="sell", decimals=2, optimize=True, load=True
    )
        ...
        **kwargs,
        ...
        if last_candle is not None:
            if (current_profit > self.sell_custom_profit_11.value) & (
                last_candle["rsi"] < self.sell_custom_rsi_11.value
            ):
                return "signal_profit_11"
            if (
                self.sell_custom_profit_11.value
                > current_profit
                > self.sell_custom_profit_10.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_10.value):
                return "signal_profit_10"
            if (
                self.sell_custom_profit_10.value
                > current_profit
                > self.sell_custom_profit_9.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_9.value):
                return "signal_profit_9"
            if (
                self.sell_custom_profit_9.value
                > current_profit
                > self.sell_custom_profit_8.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_8.value):
                return "signal_profit_8"
            if (
                self.sell_custom_profit_8.value
                > current_profit
                > self.sell_custom_profit_7.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_7.value):
                return "signal_profit_7"
            if (
                self.sell_custom_profit_7.value
                > current_profit
                > self.sell_custom_profit_6.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_6.value):
                return "signal_profit_6"
            if (
                self.sell_custom_profit_6.value
                > current_profit
                > self.sell_custom_profit_5.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_5.value):
                return "signal_profit_5"
            elif (
                self.sell_custom_profit_5.value
                > current_profit
                > self.sell_custom_profit_4.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_4.value):
                return "signal_profit_4"
            elif (
                self.sell_custom_profit_4.value
                > current_profit
                > self.sell_custom_profit_3.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_3.value):
                return "signal_profit_3"
            elif (
                self.sell_custom_profit_3.value
                > current_profit
                > self.sell_custom_profit_2.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_2.value):
                return "signal_profit_2"
            elif (
                self.sell_custom_profit_2.value
                > current_profit
                > self.sell_custom_profit_1.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_1.value):
                return "signal_profit_1"
            elif (
                self.sell_custom_profit_1.value
                > current_profit
                > self.sell_custom_profit_0.value
            ) & (last_candle["rsi"] < self.sell_custom_rsi_0.value):
                return "signal_profit_0"

            # check if close is under EMA200
            elif (
                (current_profit > self.sell_custom_under_profit_11.value)
                & (last_candle["rsi"] < self.sell_custom_under_rsi_11.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                return "signal_profit_u_11"
            elif (
                (
                    self.sell_custom_under_profit_11.value
                    > current_profit
                    > self.sell_custom_under_profit_10.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_10.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_10.value
                    > current_profit
                    > self.sell_custom_under_profit_9.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_9.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_9.value
                    > current_profit
                    > self.sell_custom_under_profit_8.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_8.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_8.value
                    > current_profit
                    > self.sell_custom_under_profit_7.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_7.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_7.value
                    > current_profit
                    > self.sell_custom_under_profit_6.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_6.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_6.value
                    > current_profit
                    > self.sell_custom_under_profit_5.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_5.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_5.value
                    > current_profit
                    > self.sell_custom_under_profit_4.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_4.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_4.value
                    > current_profit
                    > self.sell_custom_under_profit_3.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_3.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_3.value
                    > current_profit
                    > self.sell_custom_under_profit_2.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_2.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_2.value
                    > current_profit
                    > self.sell_custom_under_profit_1.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_1.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_under_profit_1.value
                    > current_profit
                    > self.sell_custom_under_profit_0.value
                )
                & (last_candle["rsi"] < self.sell_custom_under_rsi_0.value)
                & (last_candle["close"] < last_candle["ema_200"])
            ):
            ...
            # check if the pair is "pumped"
                ...
                (last_candle["sell_pump_48_1_1h"])
                & (current_profit > self.sell_custom_pump_profit_1_5.value)
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_1_5.value)
            ):
                return "signal_profit_p_1_5"
            elif (
                (last_candle["sell_pump_48_1_1h"])
                & (
                    self.sell_custom_pump_profit_1_5.value
                    > current_profit
                    > self.sell_custom_pump_profit_1_4.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_1_4.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_1_4.value
                    > current_profit
                    > self.sell_custom_pump_profit_1_3.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_1_3.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_1_3.value
                    > current_profit
                    > self.sell_custom_pump_profit_1_2.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_1_2.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_1_2.value
                    > current_profit
                    > self.sell_custom_pump_profit_1_1.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_1_1.value)
            ):
                return "signal_profit_p_1_1"

            elif (
                (last_candle["sell_pump_36_1_1h"])
                & (current_profit > self.sell_custom_pump_profit_2_5.value)
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_2_5.value)
            ):
                return "signal_profit_p_2_5"
            elif (
                (last_candle["sell_pump_36_1_1h"])
                & (
                    self.sell_custom_pump_profit_2_5.value
                    > current_profit
                    > self.sell_custom_pump_profit_2_4.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_2_4.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_2_4.value
                    > current_profit
                    > self.sell_custom_pump_profit_2_3.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_2_3.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_2_3.value
                    > current_profit
                    > self.sell_custom_pump_profit_2_2.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_2_2.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_2_2.value
                    > current_profit
                    > self.sell_custom_pump_profit_2_1.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_2_1.value)
            ):
                return "signal_profit_p_2_1"

            elif (
                (last_candle["sell_pump_24_1_1h"])
                & (current_profit > self.sell_custom_pump_profit_3_5.value)
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_3_5.value)
            ):
                return "signal_profit_p_3_5"
            elif (
                (last_candle["sell_pump_24_1_1h"])
                & (
                    self.sell_custom_pump_profit_3_5.value
                    > current_profit
                    > self.sell_custom_pump_profit_3_4.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_3_4.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_3_4.value
                    > current_profit
                    > self.sell_custom_pump_profit_3_3.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_3_3.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_3_3.value
                    > current_profit
                    > self.sell_custom_pump_profit_3_2.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_3_2.value)
            ):
                ...
                & (
                    self.sell_custom_pump_profit_3_2.value
                    > current_profit
                    > self.sell_custom_pump_profit_3_1.value
                )
                & (last_candle["rsi"] < self.sell_custom_pump_rsi_3_1.value)
            ):
                return "signal_profit_p_3_1"

            elif (
                self.sell_custom_dec_profit_max_1.value
                > current_profit
                > self.sell_custom_dec_profit_min_1.value
            ) & (last_candle["sma_200_dec"]):
                return "signal_profit_d_1"
            elif (
                self.sell_custom_dec_profit_max_2.value
                > current_profit
                > self.sell_custom_dec_profit_min_2.value
            ...
            # Trailing
                ...
                (
                    self.sell_trail_profit_max_1.value
                    > current_profit
                    > self.sell_trail_profit_min_1.value
                )
                & (
                    self.sell_trail_rsi_min_1.value
                    < last_candle["rsi"]
                    < self.sell_trail_rsi_max_1.value
                )
                ...
                (
                    self.sell_trail_profit_max_2.value
                    > current_profit
                    > self.sell_trail_profit_min_2.value
                )
                & (
                    self.sell_trail_rsi_min_2.value
                    < last_candle["rsi"]
                    < self.sell_trail_rsi_max_2.value
                )
                ...
                (
                    self.sell_trail_profit_max_3.value
                    > current_profit
                    > self.sell_trail_profit_min_3.value
                )
                & (max_profit > (current_profit + self.sell_trail_down_3.value))
                & (last_candle["sma_200_dec_1h"])
            ):
                return "signal_profit_t_3"

            elif (
                (last_candle["close"] < last_candle["ema_200"])
                & (current_profit > self.sell_trail_profit_min_3.value)
                & (current_profit < self.sell_trail_profit_max_3.value)
                & (max_profit > (current_profit + self.sell_trail_down_3.value))
            ):
                ...
                & (
                    ...
                    < self.sell_custom_profit_under_rel_1.value
                )
                & (
                    last_candle["rsi"]
                    > last_candle["rsi_1h"]
                    + self.sell_custom_profit_under_rsi_diff_1.value
                )
            ):
                ...
                & (
                    ...
                    < self.sell_custom_stoploss_under_rel_1.value
                )
                & (
                    last_candle["rsi"]
                    > last_candle["rsi_1h"]
                    + self.sell_custom_stoploss_under_rsi_diff_1.value
                )
            ):
                ...
                (
                    self.sell_custom_pump_dec_profit_max_1.value
                    > current_profit
                    > self.sell_custom_pump_dec_profit_min_1.value
                )
                & (last_candle["sell_pump_48_1_1h"])
                & (last_candle["sma_200_dec"])
                & (last_candle["close"] < last_candle["ema_200"])
                ...
                (
                    self.sell_custom_pump_dec_profit_max_2.value
                    > current_profit
                    > self.sell_custom_pump_dec_profit_min_2.value
                )
                & (last_candle["sell_pump_48_2_1h"])
                & (last_candle["sma_200_dec"])
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_pump_dec_profit_max_3.value
                    > current_profit
                    > self.sell_custom_pump_dec_profit_min_3.value
                )
                & (last_candle["sell_pump_48_3_1h"])
                & (last_candle["sma_200_dec"])
                & (last_candle["close"] < last_candle["ema_200"])
            ):
                ...
                (
                    self.sell_custom_pump_dec_profit_max_4.value
                    > current_profit
                    > self.sell_custom_pump_dec_profit_min_4.value
                )
                & (last_candle["sma_200_dec"])
                & (last_candle["sell_pump_24_2_1h"])
            ):
            ...
            # Pumped 48h 1, under EMA200
                ...
                (
                    self.sell_custom_pump_under_profit_max_1.value
                    > current_profit
                    > self.sell_custom_pump_under_profit_min_1.value
                )
                & (last_candle["sell_pump_48_1_1h"])
                & (last_candle["close"] < last_candle["ema_200"])
            ):
            ...
            # Pumped 36h 2, trail 1
                ...
                & (
                    self.sell_custom_pump_trail_profit_max_1.value
                    > current_profit
                    > self.sell_custom_pump_trail_profit_min_1.value
                )
                & (
                    self.sell_custom_pump_trail_rsi_min_1.value
                    < last_candle["rsi"]
                    < self.sell_custom_pump_trail_rsi_max_1.value
                )
                & (
                    max_profit
                    > (current_profit + self.sell_custom_pump_trail_down_1.value)
                )
            ):
                return "signal_profit_p_t_1"

            elif (
                (max_profit < self.sell_custom_stoploss_pump_max_profit_1.value)
                & (
                    self.sell_custom_stoploss_pump_min_1.value
                    < current_profit
                    < self.sell_custom_stoploss_pump_max_1.value
                )
                & (last_candle["sell_pump_48_1_1h"])
                & (last_candle["sma_200_dec"])
                & (
                    ...
                    < (
                        last_candle["ema_200"]
                        * self.sell_custom_stoploss_pump_ma_offset_1.value
                    )
                )
            ):
                ...
                (max_profit < self.sell_custom_stoploss_pump_max_profit_2.value)
                & (current_profit < self.sell_custom_stoploss_pump_loss_2.value)
                & (last_candle["sell_pump_48_1_1h"])
                & (last_candle["sma_200_dec_1h"])
                & (
                    last_candle["close"]
                    < (
                        last_candle["ema_200"]
                        * self.sell_custom_stoploss_pump_ma_offset_2.value
                    )
                )
            ):
                ...
                (max_profit < self.sell_custom_stoploss_pump_max_profit_3.value)
                & (current_profit < self.sell_custom_stoploss_pump_loss_3.value)
                & (last_candle["sell_pump_36_3_1h"])
                & (
                    last_candle["close"]
                    < (
                        last_candle["ema_200"]
                        * self.sell_custom_stoploss_pump_ma_offset_3.value
                    )
                )
            ):
    ...
    def hansen_HA(self, informative_df, period=6):
        ...
        dataframe["emac"] = ta.SMA(
            dataframe["hhclose"], timeperiod=period
    ...
    def do_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["bbw_expansion"] = (
            dataframe["bb_width"].rolling(window=4).apply(self.bbw_expansion)
        )
    ...
    def informative_1h_indicators(
        ...
        # Pump protections
        informative_1h["safe_pump_24_normal"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_1.value,
            self.buy_pump_pull_threshold_1.value,
        )
        informative_1h["safe_pump_36_normal"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_2.value,
            self.buy_pump_pull_threshold_2.value,
        )
        informative_1h["safe_pump_48_normal"] = self.safe_pump(
            informative_1h,
            48,
        ...
        informative_1h["safe_pump_24_strict"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_4.value,
            self.buy_pump_pull_threshold_4.value,
        )
        informative_1h["safe_pump_36_strict"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_5.value,
            self.buy_pump_pull_threshold_5.value,
        )
        informative_1h["safe_pump_48_strict"] = self.safe_pump(
            informative_1h,
            48,
        ...
        informative_1h["safe_pump_24_loose"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_7.value,
            self.buy_pump_pull_threshold_7.value,
        )
        informative_1h["safe_pump_36_loose"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_8.value,
            self.buy_pump_pull_threshold_8.value,
        )
        informative_1h["safe_pump_48_loose"] = self.safe_pump(
            informative_1h,
            48,
        ...
        informative_1h["sell_pump_48_1"] = (
            (
                informative_1h["high"].rolling(48).max()
                - informative_1h["low"].rolling(48).min()
            )
            / informative_1h["low"].rolling(48).min()
        ) > self.sell_pump_threshold_1.value
        informative_1h["sell_pump_48_2"] = (
            ...
            / informative_1h["low"].rolling(48).min()
        ) > self.sell_pump_threshold_2.value
        informative_1h["sell_pump_48_3"] = (
            ...
            / informative_1h["low"].rolling(48).min()
        ) > self.sell_pump_threshold_3.value

        informative_1h["sell_pump_36_1"] = (
            (
                informative_1h["high"].rolling(36).max()
                - informative_1h["low"].rolling(36).min()
            )
            / informative_1h["low"].rolling(36).min()
        ) > self.sell_pump_threshold_4.value
        informative_1h["sell_pump_36_2"] = (
            ...
            / informative_1h["low"].rolling(36).min()
        ) > self.sell_pump_threshold_5.value
        informative_1h["sell_pump_36_3"] = (
            ...
            / informative_1h["low"].rolling(36).min()
        ) > self.sell_pump_threshold_6.value

        informative_1h["sell_pump_24_1"] = (
            (
                informative_1h["high"].rolling(24).max()
                - informative_1h["low"].rolling(24).min()
            )
            / informative_1h["low"].rolling(24).min()
        ) > self.sell_pump_threshold_7.value
        informative_1h["sell_pump_24_2"] = (
            ...
            / informative_1h["low"].rolling(24).min()
        ) > self.sell_pump_threshold_8.value
        informative_1h["sell_pump_24_3"] = (
            ...
            / informative_1h["low"].rolling(24).min()
        ) > self.sell_pump_threshold_9.value
    ...
    def range_percent_change(self, dataframe: DataFrame, length: int) -> float:
        ...
        df = dataframe.copy()
        return (
            df["open"].rolling(length).max() - df["close"].rolling(length).min()
        ) / df["close"].rolling(length).min()
    ...
    def safe_pump(
        ...
        """
        df = dataframe.copy()
        return (self.range_percent_change(df, length) < thresh) | (
            self.range_maxgap_adjusted(df, length, pull_thresh)
            > self.range_height(df, length)
        )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.config["runmode"].value in ("backtest", "hyperopt"):
            assert (
                timeframe_to_minutes(self.timeframe) <= 30
        ...
        if self.dp.runmode.value in ("backtest", "hyperopt"):
            self.custom_trade_info[metadata["pair"]]["roc"] = (
                dataframe[["date", "roc"]].copy().set_index("date")
            )
            self.custom_trade_info[metadata["pair"]]["atr"] = (
                dataframe[["date", "atr"]].copy().set_index("date")
            )
            self.custom_trade_info[metadata["pair"]]["sroc"] = (
                dataframe[["date", "sroc"]].copy().set_index("date")
            )
            self.custom_trade_info[metadata["pair"]]["ssl-dir"] = (
                dataframe[["date", "ssl-dir"]].copy().set_index("date")
            )
            self.custom_trade_info[metadata["pair"]]["rmi-up-trend"] = (
                dataframe[["date", "rmi-up-trend"]].copy().set_index("date")
            )
            self.custom_trade_info[metadata["pair"]]["candle-up-trend"] = (
                dataframe[["date", "candle-up-trend"]].copy().set_index("date")
            )
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.buy_01_protection__ema_fast.value:
            buy_01_protections.append(
                dataframe[f"ema_{self.buy_01_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_01_protection__ema_slow.value:
            buy_01_protections.append(
                dataframe[f"ema_{self.buy_01_protection__ema_slow_len.value}_1h"]
        ...
        if self.buy_01_protection__close_above_ema_fast.value:
            buy_01_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_01_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_01_protection__close_above_ema_slow.value:
            buy_01_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_01_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_01_protection__sma200_rising.value:
            buy_01_protections.append(
                ...
                > dataframe["sma_200"].shift(
                    int(self.buy_01_protection__sma200_rising_val.value)
                )
            )
        if self.buy_01_protection__sma200_1h_rising.value:
            buy_01_protections.append(
                ...
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_01_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_01_protection__safe_dips.value:
            buy_01_protections.append(
                dataframe[f"safe_dips_{self.buy_01_protection__safe_dips_type.value}"]
            )
        if self.buy_01_protection__safe_pump.value:
            buy_01_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_01_protection__safe_pump_period.value}_{self.buy_01_protection__safe_pump_type.value}_1h"
                ]
            )
        ...
        if self.buy_02_protection__ema_fast.value:
            buy_02_protections.append(
                dataframe[f"ema_{self.buy_02_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_02_protection__ema_slow.value:
            buy_02_protections.append(
                dataframe[f"ema_{self.buy_02_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_02_protection__close_above_ema_fast.value:
            buy_02_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_02_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_02_protection__close_above_ema_slow.value:
            buy_02_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_02_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_02_protection__sma200_rising.value:
            buy_02_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_02_protection__sma200_rising_val.value)
                )
            )
        if self.buy_02_protection__sma200_1h_rising.value:
            buy_02_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_02_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_02_protection__safe_dips.value:
            buy_02_protections.append(
                dataframe[f"safe_dips_{self.buy_02_protection__safe_dips_type.value}"]
            )
        if self.buy_02_protection__safe_pump.value:
            buy_02_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_02_protection__safe_pump_period.value}_{self.buy_02_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_03_protection__ema_fast.value:
            buy_03_protections.append(
                dataframe[f"ema_{self.buy_03_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_03_protection__ema_slow.value:
            buy_03_protections.append(
                dataframe[f"ema_{self.buy_03_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_03_protection__close_above_ema_fast.value:
            buy_03_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_03_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_03_protection__close_above_ema_slow.value:
            buy_03_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_03_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_03_protection__sma200_rising.value:
            buy_03_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_03_protection__sma200_rising_val.value)
                )
            )
        if self.buy_03_protection__sma200_1h_rising.value:
            buy_03_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_03_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_03_protection__safe_dips.value:
            buy_03_protections.append(
                dataframe[f"safe_dips_{self.buy_03_protection__safe_dips_type.value}"]
            )
        if self.buy_03_protection__safe_pump.value:
            buy_03_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_03_protection__safe_pump_period.value}_{self.buy_03_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        buy_03_protections.append(
        ...
        if self.buy_04_protection__ema_fast.value:
            buy_04_protections.append(
                dataframe[f"ema_{self.buy_04_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_04_protection__ema_slow.value:
            buy_04_protections.append(
                dataframe[f"ema_{self.buy_04_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_04_protection__close_above_ema_fast.value:
            buy_04_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_04_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_04_protection__close_above_ema_slow.value:
            buy_04_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_04_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_04_protection__sma200_rising.value:
            buy_04_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_04_protection__sma200_rising_val.value)
                )
            )
        if self.buy_04_protection__sma200_1h_rising.value:
            buy_04_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_04_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_04_protection__safe_dips.value:
            buy_04_protections.append(
                dataframe[f"safe_dips_{self.buy_04_protection__safe_dips_type.value}"]
            )
        if self.buy_04_protection__safe_pump.value:
            buy_04_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_04_protection__safe_pump_period.value}_{self.buy_04_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        buy_04_logic.append(
            dataframe["close"]
            < self.buy_bb20_close_bblowerband_4.value * dataframe["bb_lowerband"]
        )
        buy_04_logic.append(
            dataframe["volume"]
        ...
        if self.buy_05_protection__ema_fast.value:
            buy_05_protections.append(
                dataframe[f"ema_{self.buy_05_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_05_protection__ema_slow.value:
            buy_05_protections.append(
                dataframe[f"ema_{self.buy_05_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_05_protection__close_above_ema_fast.value:
            buy_05_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_05_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_05_protection__close_above_ema_slow.value:
            buy_05_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_05_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_05_protection__sma200_rising.value:
            buy_05_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_05_protection__sma200_rising_val.value)
                )
            )
        if self.buy_05_protection__sma200_1h_rising.value:
            buy_05_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_05_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_05_protection__safe_dips.value:
            buy_05_protections.append(
                dataframe[f"safe_dips_{self.buy_05_protection__safe_dips_type.value}"]
            )
        if self.buy_05_protection__safe_pump.value:
            buy_05_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_05_protection__safe_pump_period.value}_{self.buy_05_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        buy_05_protections.append(
        ...
        if self.buy_06_protection__ema_fast.value:
            buy_06_protections.append(
                dataframe[f"ema_{self.buy_06_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_06_protection__ema_slow.value:
            buy_06_protections.append(
                dataframe[f"ema_{self.buy_06_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_06_protection__close_above_ema_fast.value:
            buy_06_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_06_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_06_protection__close_above_ema_slow.value:
            buy_06_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_06_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_06_protection__sma200_rising.value:
            buy_06_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_06_protection__sma200_rising_val.value)
                )
            )
        if self.buy_06_protection__sma200_1h_rising.value:
            buy_06_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_06_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_06_protection__safe_dips.value:
            buy_06_protections.append(
                dataframe[f"safe_dips_{self.buy_06_protection__safe_dips_type.value}"]
            )
        if self.buy_06_protection__safe_pump.value:
            buy_06_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_06_protection__safe_pump_period.value}_{self.buy_06_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_07_protection__ema_fast.value:
            buy_07_protections.append(
                dataframe[f"ema_{self.buy_07_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_07_protection__ema_slow.value:
            buy_07_protections.append(
                dataframe[f"ema_{self.buy_07_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_07_protection__close_above_ema_fast.value:
            buy_07_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_07_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_07_protection__close_above_ema_slow.value:
            buy_07_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_07_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_07_protection__sma200_rising.value:
            buy_07_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_07_protection__sma200_rising_val.value)
                )
            )
        if self.buy_07_protection__sma200_1h_rising.value:
            buy_07_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_07_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_07_protection__safe_dips.value:
            buy_07_protections.append(
                dataframe[f"safe_dips_{self.buy_07_protection__safe_dips_type.value}"]
            )
        if self.buy_07_protection__safe_pump.value:
            buy_07_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_07_protection__safe_pump_period.value}_{self.buy_07_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_08_protection__ema_fast.value:
            buy_08_protections.append(
                dataframe[f"ema_{self.buy_08_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_08_protection__ema_slow.value:
            buy_08_protections.append(
                dataframe[f"ema_{self.buy_08_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_08_protection__close_above_ema_fast.value:
            buy_08_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_08_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_08_protection__close_above_ema_slow.value:
            buy_08_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_08_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_08_protection__sma200_rising.value:
            buy_08_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_08_protection__sma200_rising_val.value)
                )
            )
        if self.buy_08_protection__sma200_1h_rising.value:
            buy_08_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_08_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_08_protection__safe_dips.value:
            buy_08_protections.append(
                dataframe[f"safe_dips_{self.buy_08_protection__safe_dips_type.value}"]
            )
        if self.buy_08_protection__safe_pump.value:
            buy_08_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_08_protection__safe_pump_period.value}_{self.buy_08_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_09_protection__ema_fast.value:
            buy_09_protections.append(
                dataframe[f"ema_{self.buy_09_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_09_protection__ema_slow.value:
            buy_09_protections.append(
                dataframe[f"ema_{self.buy_09_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_09_protection__close_above_ema_fast.value:
            buy_09_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_09_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_09_protection__close_above_ema_slow.value:
            buy_09_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_09_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_09_protection__sma200_rising.value:
            buy_09_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_09_protection__sma200_rising_val.value)
                )
            )
        if self.buy_09_protection__sma200_1h_rising.value:
            buy_09_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_09_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_09_protection__safe_dips.value:
            buy_09_protections.append(
                dataframe[f"safe_dips_{self.buy_09_protection__safe_dips_type.value}"]
            )
        if self.buy_09_protection__safe_pump.value:
            buy_09_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_09_protection__safe_pump_period.value}_{self.buy_09_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_10_protection__ema_fast.value:
            buy_10_protections.append(
                dataframe[f"ema_{self.buy_10_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_10_protection__ema_slow.value:
            buy_10_protections.append(
                dataframe[f"ema_{self.buy_10_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_10_protection__close_above_ema_fast.value:
            buy_10_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_10_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_10_protection__close_above_ema_slow.value:
            buy_10_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_10_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_10_protection__sma200_rising.value:
            buy_10_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_10_protection__sma200_rising_val.value)
                )
            )
        if self.buy_10_protection__sma200_1h_rising.value:
            buy_10_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_10_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_10_protection__safe_dips.value:
            buy_10_protections.append(
                dataframe[f"safe_dips_{self.buy_10_protection__safe_dips_type.value}"]
            )
        if self.buy_10_protection__safe_pump.value:
            buy_10_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_10_protection__safe_pump_period.value}_{self.buy_10_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_11_protection__ema_fast.value:
            buy_11_protections.append(
                dataframe[f"ema_{self.buy_11_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_11_protection__ema_slow.value:
            buy_11_protections.append(
                dataframe[f"ema_{self.buy_11_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_11_protection__close_above_ema_fast.value:
            buy_11_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_11_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_11_protection__close_above_ema_slow.value:
            buy_11_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_11_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_11_protection__sma200_rising.value:
            buy_11_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_11_protection__sma200_rising_val.value)
                )
            )
        if self.buy_11_protection__sma200_1h_rising.value:
            buy_11_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_11_protection__sma200_1h_rising_val.value)
                )
            )
        ...
        if self.buy_11_protection__safe_pump.value:
            buy_11_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_11_protection__safe_pump_period.value}_{self.buy_11_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_12_protection__ema_fast.value:
            buy_12_protections.append(
                dataframe[f"ema_{self.buy_12_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_12_protection__ema_slow.value:
            buy_12_protections.append(
                dataframe[f"ema_{self.buy_12_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_12_protection__close_above_ema_fast.value:
            buy_12_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_12_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_12_protection__close_above_ema_slow.value:
            buy_12_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_12_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_12_protection__sma200_rising.value:
            buy_12_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_12_protection__sma200_rising_val.value)
                )
            )
        if self.buy_12_protection__sma200_1h_rising.value:
            buy_12_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_12_protection__sma200_1h_rising_val.value)
                )
            )
        ...
        if self.buy_12_protection__safe_pump.value:
            buy_12_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_12_protection__safe_pump_period.value}_{self.buy_12_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_13_protection__ema_fast.value:
            buy_13_protections.append(
                dataframe[f"ema_{self.buy_13_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_13_protection__ema_slow.value:
            buy_13_protections.append(
                dataframe[f"ema_{self.buy_13_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_13_protection__close_above_ema_fast.value:
            buy_13_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_13_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_13_protection__close_above_ema_slow.value:
            buy_13_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_13_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_13_protection__sma200_rising.value:
            buy_13_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_13_protection__sma200_rising_val.value)
                )
            )
        if self.buy_13_protection__sma200_1h_rising.value:
            buy_13_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_13_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_13_protection__safe_dips.value:
            buy_13_protections.append(
                dataframe[f"safe_dips_{self.buy_13_protection__safe_dips_type.value}"]
            )
        if self.buy_13_protection__safe_pump.value:
            buy_13_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_13_protection__safe_pump_period.value}_{self.buy_13_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_14_protection__ema_fast.value:
            buy_14_protections.append(
                dataframe[f"ema_{self.buy_14_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_14_protection__ema_slow.value:
            buy_14_protections.append(
                dataframe[f"ema_{self.buy_14_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_14_protection__close_above_ema_fast.value:
            buy_14_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_14_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_14_protection__close_above_ema_slow.value:
            buy_14_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_14_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_14_protection__sma200_rising.value:
            buy_14_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_14_protection__sma200_rising_val.value)
                )
            )
        if self.buy_14_protection__sma200_1h_rising.value:
            buy_14_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_14_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_14_protection__safe_dips.value:
            buy_14_protections.append(
                dataframe[f"safe_dips_{self.buy_14_protection__safe_dips_type.value}"]
            )
        if self.buy_14_protection__safe_pump.value:
            buy_14_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_14_protection__safe_pump_period.value}_{self.buy_14_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_15_protection__ema_fast.value:
            buy_15_protections.append(
                dataframe[f"ema_{self.buy_15_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_15_protection__ema_slow.value:
            buy_15_protections.append(
                dataframe[f"ema_{self.buy_15_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_15_protection__close_above_ema_fast.value:
            buy_15_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_15_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_15_protection__close_above_ema_slow.value:
            buy_15_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_15_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_15_protection__sma200_rising.value:
            buy_15_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_15_protection__sma200_rising_val.value)
                )
            )
        if self.buy_15_protection__sma200_1h_rising.value:
            buy_15_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_15_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_15_protection__safe_dips.value:
            buy_15_protections.append(
                dataframe[f"safe_dips_{self.buy_15_protection__safe_dips_type.value}"]
            )
        if self.buy_15_protection__safe_pump.value:
            buy_15_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_15_protection__safe_pump_period.value}_{self.buy_15_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        buy_15_protections.append(
        ...
        if self.buy_16_protection__ema_fast.value:
            buy_16_protections.append(
                dataframe[f"ema_{self.buy_16_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_16_protection__ema_slow.value:
            buy_16_protections.append(
                dataframe[f"ema_{self.buy_16_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_16_protection__close_above_ema_fast.value:
            buy_16_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_16_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_16_protection__close_above_ema_slow.value:
            buy_16_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_16_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_16_protection__sma200_rising.value:
            buy_16_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_16_protection__sma200_rising_val.value)
                )
            )
        if self.buy_16_protection__sma200_1h_rising.value:
            buy_16_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_16_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_16_protection__safe_dips.value:
            buy_16_protections.append(
                dataframe[f"safe_dips_{self.buy_16_protection__safe_dips_type.value}"]
            )
        if self.buy_16_protection__safe_pump.value:
            buy_16_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_16_protection__safe_pump_period.value}_{self.buy_16_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_17_protection__ema_fast.value:
            buy_17_protections.append(
                dataframe[f"ema_{self.buy_17_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_17_protection__ema_slow.value:
            buy_17_protections.append(
                dataframe[f"ema_{self.buy_17_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_17_protection__close_above_ema_fast.value:
            buy_17_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_17_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_17_protection__close_above_ema_slow.value:
            buy_17_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_17_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_17_protection__sma200_rising.value:
            buy_17_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_17_protection__sma200_rising_val.value)
                )
            )
        if self.buy_17_protection__sma200_1h_rising.value:
            buy_17_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_17_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_17_protection__safe_dips.value:
            buy_17_protections.append(
                dataframe[f"safe_dips_{self.buy_17_protection__safe_dips_type.value}"]
            )
        if self.buy_17_protection__safe_pump.value:
            buy_17_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_17_protection__safe_pump_period.value}_{self.buy_17_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_18_protection__ema_fast.value:
            buy_18_protections.append(
                dataframe[f"ema_{self.buy_18_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_18_protection__ema_slow.value:
            buy_18_protections.append(
                dataframe[f"ema_{self.buy_18_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_18_protection__close_above_ema_fast.value:
            buy_18_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_18_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_18_protection__close_above_ema_slow.value:
            buy_18_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_18_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_18_protection__sma200_rising.value:
            buy_18_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_18_protection__sma200_rising_val.value)
                )
            )
        if self.buy_18_protection__sma200_1h_rising.value:
            buy_18_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_18_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_18_protection__safe_dips.value:
            buy_18_protections.append(
                dataframe[f"safe_dips_{self.buy_18_protection__safe_dips_type.value}"]
            )
        if self.buy_18_protection__safe_pump.value:
            buy_18_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_18_protection__safe_pump_period.value}_{self.buy_18_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_19_protection__ema_fast.value:
            buy_19_protections.append(
                dataframe[f"ema_{self.buy_19_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_19_protection__ema_slow.value:
            buy_19_protections.append(
                dataframe[f"ema_{self.buy_19_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_19_protection__close_above_ema_fast.value:
            buy_19_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_19_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_19_protection__close_above_ema_slow.value:
            buy_19_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_19_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_19_protection__sma200_rising.value:
            buy_19_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_19_protection__sma200_rising_val.value)
                )
            )
        if self.buy_19_protection__sma200_1h_rising.value:
            buy_19_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_19_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_19_protection__safe_dips.value:
            buy_19_protections.append(
                dataframe[f"safe_dips_{self.buy_19_protection__safe_dips_type.value}"]
            )
        if self.buy_19_protection__safe_pump.value:
            buy_19_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_19_protection__safe_pump_period.value}_{self.buy_19_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_20_protection__ema_fast.value:
            buy_20_protections.append(
                dataframe[f"ema_{self.buy_20_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_20_protection__ema_slow.value:
            buy_20_protections.append(
                dataframe[f"ema_{self.buy_20_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_20_protection__close_above_ema_fast.value:
            buy_20_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_20_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_20_protection__close_above_ema_slow.value:
            buy_20_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_20_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_20_protection__sma200_rising.value:
            buy_20_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_20_protection__sma200_rising_val.value)
                )
            )
        if self.buy_20_protection__sma200_1h_rising.value:
            buy_20_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_20_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_20_protection__safe_dips.value:
            buy_20_protections.append(
                dataframe[f"safe_dips_{self.buy_20_protection__safe_dips_type.value}"]
            )
        if self.buy_20_protection__safe_pump.value:
            buy_20_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_20_protection__safe_pump_period.value}_{self.buy_20_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_21_protection__ema_fast.value:
            buy_21_protections.append(
                dataframe[f"ema_{self.buy_21_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_21_protection__ema_slow.value:
            buy_21_protections.append(
                dataframe[f"ema_{self.buy_21_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_21_protection__close_above_ema_fast.value:
            buy_21_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_21_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_21_protection__close_above_ema_slow.value:
            buy_21_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_21_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_21_protection__sma200_rising.value:
            buy_21_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_21_protection__sma200_rising_val.value)
                )
            )
        if self.buy_21_protection__sma200_1h_rising.value:
            buy_21_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_21_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_21_protection__safe_dips.value:
            buy_21_protections.append(
                dataframe[f"safe_dips_{self.buy_21_protection__safe_dips_type.value}"]
            )
        if self.buy_21_protection__safe_pump.value:
            buy_21_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_21_protection__safe_pump_period.value}_{self.buy_21_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        if self.buy_22_protection__ema_fast.value:
            buy_22_protections.append(
                dataframe[f"ema_{self.buy_22_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_22_protection__ema_slow.value:
            buy_22_protections.append(
                dataframe[f"ema_{self.buy_22_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_22_protection__close_above_ema_fast.value:
            buy_22_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_22_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_22_protection__close_above_ema_slow.value:
            buy_22_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_22_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_22_protection__sma200_rising.value:
            buy_22_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_22_protection__sma200_rising_val.value)
                )
            )
        if self.buy_22_protection__sma200_1h_rising.value:
            buy_22_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_22_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_22_protection__safe_dips.value:
            buy_22_protections.append(
                dataframe[f"safe_dips_{self.buy_22_protection__safe_dips_type.value}"]
            )
        if self.buy_22_protection__safe_pump.value:
            buy_22_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_22_protection__safe_pump_period.value}_{self.buy_22_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        buy_22_protections.append(
        ...
        buy_22_logic.append(
            (dataframe["volume_mean_4"] * self.buy_volume_22.value)
            > dataframe["volume"]
        )
        buy_22_logic.append(
        ...
        buy_22_logic.append(
            dataframe["close"]
            < (dataframe["bb_lowerband"] * self.buy_bb_offset_22.value)
        )
        ...
        if self.buy_23_protection__ema_fast.value:
            buy_23_protections.append(
                dataframe[f"ema_{self.buy_23_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_23_protection__ema_slow.value:
            buy_23_protections.append(
                dataframe[f"ema_{self.buy_23_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_23_protection__close_above_ema_fast.value:
            buy_23_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_23_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_23_protection__close_above_ema_slow.value:
            buy_23_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_23_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_23_protection__sma200_rising.value:
            buy_23_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_23_protection__sma200_rising_val.value)
                )
            )
        if self.buy_23_protection__sma200_1h_rising.value:
            buy_23_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_23_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_23_protection__safe_dips.value:
            buy_23_protections.append(
                dataframe[f"safe_dips_{self.buy_23_protection__safe_dips_type.value}"]
            )
        if self.buy_23_protection__safe_pump.value:
            buy_23_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_23_protection__safe_pump_period.value}_{self.buy_23_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        buy_23_logic.append(
            dataframe["close"]
            < (dataframe["bb_lowerband"] * self.buy_bb_offset_23.value)
        )
        ...
        if self.buy_24_protection__ema_fast.value:
            buy_24_protections.append(
                dataframe[f"ema_{self.buy_24_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_24_protection__ema_slow.value:
            buy_24_protections.append(
                dataframe[f"ema_{self.buy_24_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_24_protection__close_above_ema_fast.value:
            buy_24_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_24_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_24_protection__close_above_ema_slow.value:
            buy_24_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_24_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_24_protection__sma200_rising.value:
            buy_24_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_24_protection__sma200_rising_val.value)
                )
            )
        if self.buy_24_protection__sma200_1h_rising.value:
            buy_24_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_24_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_24_protection__safe_dips.value:
            buy_24_protections.append(
                dataframe[f"safe_dips_{self.buy_24_protection__safe_dips_type.value}"]
            )
        if self.buy_24_protection__safe_pump.value:
            buy_24_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_24_protection__safe_pump_period.value}_{self.buy_24_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        dataframe.loc[
            (
                ...
                & (
                    ...
                    (
                        (dataframe["bbw_expansion"] == 1)
                        & ((dataframe["mfi"] > 80) | (dataframe["dmi_plus"] > 30))
                    )
                    ## volume sanity checks
                    & (dataframe["vfi"] > 0.0)
                    & (dataframe["volume"] > 0)
    ...
    def min_roi_reached_dynamic(
        ...
        if self.custom_trade_info and trade and trade.pair in self.custom_trade_info:
            ...
            # If in backtest or hyperopt, get the indicator values out of the trades dict (Thanks @JoeSchr!)
                ...
                rmi_trend = self.custom_trade_info[trade.pair]["rmi-up-trend"].loc[
                    current_time
                ]["rmi-up-trend"]
                candle_trend = self.custom_trade_info[trade.pair][
                    "candle-up-trend"
                ].loc[current_time]["candle-up-trend"]
                ssl_dir = self.custom_trade_info[trade.pair]["ssl-dir"].loc[
                    current_time
                ]["ssl-dir"]
