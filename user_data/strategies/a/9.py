...
9.py
Buy Stop ROI
    60/100:   1011 trades. Avg profit   0.61%. Total profit  0.05508114 BTC ( 621.06Σ%). Avg duration 825.3 min. Objective: -65.23248

Backtest in-sample:
|     TOTAL |   1011 |           0.61 |         621.06 |       0.05508114 |           0.00 |        13:45:00 |    550 |     457 |        4 |
======================================================== SELL REASON STATS =========================================================
|        Sell Reason |   Sells |   Wins |   Draws |   Losses |   Avg Profit % |   Cum Profit % |   Tot Profit BTC |   Tot Profit % |
|--------------------+---------+--------+---------+----------+----------------+----------------+------------------+----------------|
|                roi |     765 |    308 |     457 |        0 |           0.26 |         200.55 |       0.0177869  |              0 |
| trailing_stop_loss |     242 |    242 |       0 |        0 |           1.83 |         441.7  |       0.0391739  |              0 |
|         force_sell |       4 |      0 |       0 |        4 |          -5.3  |         -21.19 |      -0.00187962 |             -0 |
...
class BBRSICCI5m(IStrategy):
    ...
    # ROI table:
    minimal_roi = {"0": 0.15444, "38": 0.1054, "86": 0.0396, "105": 0}
