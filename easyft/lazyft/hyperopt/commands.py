...
class HyperoptCommand:
    ...
    def build_command(
        ...
        timerange = timerange or QuickTools.get_timerange(days, interval, self.config, False)
...
def new_hyperopt_cli(
    ...
    loss_function: str = typer.Option("0", "-L", "--loss-function", help=QuickHyperopt.losses_help),
...
def create_commands(
    ...
    for s in strategies:
        ...
        command.build_command(interval, epochs, min_trades, spaces, loss_function, days, timerange)
