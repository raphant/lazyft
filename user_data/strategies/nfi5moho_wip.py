...
class NFI5MOHO_WIP(IStrategy):
    ...
    # endregion
    # ROI table:
    minimal_roi = {"0": 0.08, "10": 0.04, "30": 0.02, "60": 0.01}
    ...
    buy_dip_threshold_6 = DecimalParameter(
        0.01, 0.2, default=0.06, space='buy', decimals=3, optimize=False, load=True
    )
    buy_dip_threshold_7 = DecimalParameter(
        0.05, 0.4, default=0.24, space='buy', decimals=3, optimize=False, load=True
    )
    buy_dip_threshold_8 = DecimalParameter(
        0.2, 0.5, default=0.4, space='buy', decimals=3, optimize=False, load=True
    )
    # Loose dips
    ...
    buy_dip_threshold_10 = DecimalParameter(
        0.01, 0.2, default=0.24, space='buy', decimals=3, optimize=False, load=True
    )
    buy_dip_threshold_11 = DecimalParameter(
        0.05, 0.4, default=0.42, space='buy', decimals=3, optimize=False, load=True
    )
    buy_dip_threshold_12 = DecimalParameter(
        0.2, 0.5, default=0.66, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_pump_threshold_2 = DecimalParameter(
        0.4, 1.0, default=0.56, space='buy', decimals=3, optimize=False, load=True
    )
    # 48 hours
    ...
    buy_pump_threshold_4 = DecimalParameter(
        0.4, 1.0, default=0.4, space='buy', decimals=3, optimize=False, load=True
    )
    # 36 hours strict
    ...
    buy_pump_pull_threshold_9 = DecimalParameter(
        1.5, 3.0, default=1.4, space='buy', decimals=2, optimize=False, load=True
    )
    buy_pump_threshold_9 = DecimalParameter(
        0.4, 1.8, default=1.3, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_mfi_1 = DecimalParameter(
        20.0, 40.0, default=26.0, space='buy', decimals=1, optimize=False, load=True
    )

    buy_volume_2 = DecimalParameter(
        1.0, 10.0, default=2.6, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_bb40_bbdelta_close_3 = DecimalParameter(
        0.005, 0.06, default=0.057, space='buy', optimize=False, load=True
    )
    ...
    buy_ema_open_mult_5 = DecimalParameter(
        0.016, 0.03, default=0.019, space='buy', decimals=3, optimize=False, load=True
    )
    buy_bb_offset_5 = DecimalParameter(
        0.98, 1.0, default=0.999, space='buy', decimals=3, optimize=False, load=True
    )
    buy_ema_rel_5 = DecimalParameter(
        0.97, 0.999, default=0.982, space='buy', decimals=3, optimize=False, load=True
    )

    buy_ema_open_mult_6 = DecimalParameter(
        0.02, 0.03, default=0.025, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_volume_7 = DecimalParameter(
        1.0, 10.0, default=2.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_7 = DecimalParameter(
        24.0, 50.0, default=36.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        36.0, 40.0, default=20.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_volume_9 = DecimalParameter(
        1.0, 4.0, default=1.0, space='buy', decimals=2, optimize=False, load=True
    )
    buy_ma_offset_9 = DecimalParameter(
        0.94, 0.99, default=0.97, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_mfi_9 = DecimalParameter(
        36.0, 65.0, default=30.0, space='buy', decimals=1, optimize=False, load=True
    )

    buy_volume_10 = DecimalParameter(
        1.0, 8.0, default=2.4, space='buy', decimals=1, optimize=False, load=True
    )
    buy_ma_offset_10 = DecimalParameter(
        0.93, 0.97, default=0.944, space='buy', decimals=3, optimize=False, load=True
    )
    buy_bb_offset_10 = DecimalParameter(
        0.97, 0.99, default=0.994, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_ma_offset_11 = DecimalParameter(
        0.93, 0.99, default=0.939, space='buy', decimals=3, optimize=False, load=True
    )
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.022, space='buy', decimals=3, optimize=False, load=True
    )
    buy_rsi_1h_min_11 = DecimalParameter(
        40.0, 60.0, default=56.0, space='buy', decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_max_11 = DecimalParameter(
        70.0, 90.0, default=84.0, space='buy', decimals=1, optimize=False, load=True
    )
    buy_rsi_11 = DecimalParameter(
        30.0, 48.0, default=48.0, space='buy', decimals=1, optimize=False, load=True
    )
    buy_mfi_11 = DecimalParameter(
        36.0, 56.0, default=38.0, space='buy', decimals=1, optimize=False, load=True
    )

    buy_volume_12 = DecimalParameter(
        1.0, 10.0, default=1.7, space='buy', decimals=1, optimize=False, load=True
    )
    buy_ma_offset_12 = DecimalParameter(
        0.93, 0.97, default=0.936, space='buy', decimals=3, optimize=False, load=True
    )
    buy_rsi_12 = DecimalParameter(
        26.0, 40.0, default=30.0, space='buy', decimals=1, optimize=False, load=True
    )
    buy_ewo_12 = DecimalParameter(
        2.0, 6.0, default=2.0, space='buy', decimals=1, optimize=False, load=True
    )

    buy_volume_13 = DecimalParameter(
        1.0, 10.0, default=1.6, space='buy', decimals=1, optimize=False, load=True
    )
    buy_ma_offset_13 = DecimalParameter(
        0.93, 0.98, default=0.978, space='buy', decimals=3, optimize=False, load=True
    )
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-10.4, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_ma_offset_14 = DecimalParameter(
        0.93, 0.99, default=0.97, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_ema_open_mult_15 = DecimalParameter(
        0.02, 0.04, default=0.018, space='buy', decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_15 = DecimalParameter(
        30.0, 50.0, default=28.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_16 = DecimalParameter(
        4.0, 8.0, default=2.8, space='buy', decimals=1, optimize=False, load=True
    )

    buy_volume_17 = DecimalParameter(
        0.5, 8.0, default=2.0, space='buy', decimals=1, optimize=False, load=True
    )
    buy_ma_offset_17 = DecimalParameter(
        0.93, 0.98, default=0.958, space='buy', decimals=3, optimize=False, load=True
    )
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-12.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_volume_20 = DecimalParameter(
        0.5, 6.0, default=1.2, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_20 = DecimalParameter(
        20.0, 36.0, default=26.0, space='buy', decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_rsi_0 = DecimalParameter(
        30.0, 40.0, default=33.0, space='sell', decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_rsi_1 = DecimalParameter(
        30.0, 50.0, default=38.0, space='sell', decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_2 = DecimalParameter(
        34.0, 50.0, default=43.0, space='sell', decimals=2, optimize=False, load=True
    )
    sell_custom_profit_3 = DecimalParameter(
        0.06, 0.30, default=0.08, space='sell', decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_profit_4 = DecimalParameter(
        0.3, 0.6, default=0.25, space='sell', decimals=3, optimize=False, load=True
    )
    sell_custom_rsi_4 = DecimalParameter(
        40.0, 58.0, default=50.0, space='sell', decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_under_profit_3 = DecimalParameter(
        0.01, 0.10, default=0.6, space='sell', decimals=3, optimize=False, load=True
    )
    sell_custom_under_rsi_3 = DecimalParameter(
        50.0, 68.0, default=62.0, space='sell', decimals=1, optimize=False, load=True
    )

    sell_custom_dec_profit_1 = DecimalParameter(
        0.01, 0.10, default=0.05, space='sell', decimals=3, optimize=False, load=True
    )
    sell_custom_dec_profit_2 = DecimalParameter(
        0.05, 0.2, default=0.07, space='sell', decimals=3, optimize=False, load=True
    )

    sell_trail_profit_min_1 = DecimalParameter(
        0.1, 0.25, default=0.15, space='sell', decimals=3, optimize=False, load=True
    )
    sell_trail_profit_max_1 = DecimalParameter(
        0.3, 0.5, default=0.46, space='sell', decimals=2, optimize=False, load=True
    )
    sell_trail_down_1 = DecimalParameter(
        0.04, 0.2, default=0.18, space='sell', decimals=3, optimize=False, load=True
    )
    ...
    sell_trail_profit_max_2 = DecimalParameter(
        0.08, 0.25, default=0.12, space='sell', decimals=2, optimize=False, load=True
    )
    sell_trail_down_2 = DecimalParameter(
        0.04, 0.2, default=0.14, space='sell', decimals=3, optimize=False, load=True
    )
    ...
    sell_trail_profit_max_3 = DecimalParameter(
        0.08, 0.16, default=0.1, space='sell', decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(
        0.0, 20.0, default=8.0, space='sell', optimize=False, load=True
    )
    # endregion
    ...
    def informative_1h_indicators(
        ...
        # region Get the informative pair
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        # region Buy condition 1
        conditions.append(
            (
                bool(self.buy_condition_1_enable.value)
        ...
        # endregion
        # region Buy condition 2
        conditions.append(
            (
                bool(self.buy_condition_2_enable.value)
        ...
        # endregion
        # region Buy condition 3

        conditions.append(
            (
                bool(self.buy_condition_3_enable.value)
                & (
                    dataframe['close']
        ...
        # endregion
        # region Buy condition 4
        conditions.append(
            (
                bool(self.buy_condition_4_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_strict'])
                & (dataframe['safe_pump_24_1h'])
        ...
        # endregion
        # region Buy condition 5
        conditions.append(
            (
                bool(self.buy_condition_5_enable.value)
                & (dataframe['ema_100'] > dataframe['ema_200'])
                & (
                    dataframe['close']
        ...
        # endregion
        # region Buy condition 6
        conditions.append(
            (
                bool(self.buy_condition_6_enable.value)
                & (dataframe['ema_100_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_loose'])
                & (dataframe['safe_pump_36_strict_1h'])
                & (dataframe['ema_26'] > dataframe['ema_12'])
        ...
        # endregion
        # region Buy condition 7
        conditions.append(
            (
                bool(self.buy_condition_7_enable.value)
                & (dataframe['ema_100'] > dataframe['ema_200'])
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_strict'])
                & (
        ...
        # endregion 7
        # region Buy condition 8

        conditions.append(
            (
                bool(self.buy_condition_8_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_loose'])
                & (dataframe['safe_pump_24_1h'])
        ...
        # endregion
        # region Buy condition 9
        conditions.append(
            (
                bool(self.buy_condition_9_enable.value)
        ...
        conditions.append(
            (
                bool(self.buy_condition_10_enable.value)
        ...
        conditions.append(
            (
                bool(self.buy_condition_11_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_100_1h'])
                & (dataframe['safe_dips_loose'])
                & (dataframe['safe_pump_24_loose_1h'])
        ...
        conditions.append(
            (
                bool(self.buy_condition_12_enable.value)
                & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(24))
                & (dataframe['safe_dips_strict'])
                & (dataframe['safe_pump_24_1h'])
                & (
        ...
        conditions.append(
            (
                bool(self.buy_condition_13_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_100_1h'])
                & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(24))
                & (dataframe['safe_dips_strict'])
                & (dataframe['safe_pump_24_loose_1h'])
        ...
        conditions.append(
            (
                bool(self.buy_condition_14_enable.value)
        ...
        conditions.append(
            (
                bool(self.buy_condition_15_enable.value)
                & (
                    dataframe['close']
        ...
        conditions.append(
            (
                bool(self.buy_condition_16_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_strict'])
                & (dataframe['safe_pump_24_strict_1h'])
                & (
        ...
        conditions.append(
            (
                bool(self.buy_condition_17_enable.value)
                & (dataframe['safe_dips_strict'])
                & (dataframe['safe_pump_24_loose_1h'])
                & (
        ...
        conditions.append(
            (
                bool(self.buy_condition_18_enable.value)
        ...
        conditions.append(
            (
                bool(self.buy_condition_19_enable.value)
                & (dataframe['ema_100_1h'] > dataframe['ema_200_1h'])
        ...
        conditions.append(
            (
                bool(self.buy_condition_20_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips'])
                & (dataframe['safe_pump_24_loose_1h'])
                & (
        ...
        conditions.append(
            (
                bool(self.buy_condition_21_enable.value)
                & (dataframe['ema_50_1h'] > dataframe['ema_200_1h'])
                & (dataframe['safe_dips_strict'])
                & (
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            (
                bool(self.sell_condition_1_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_2_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_3_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_4_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_6_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_7_enable.value)
        ...
        conditions.append(
            (
                bool(self.sell_condition_8_enable.value)
                & (
                    dataframe['close']
