...
###########################################################################################################
##                   BigZ04_TSL3Sh by Perkmeister, based on BigZ04 by ilya                                 ##
##                                                                                                       ##
...
class BigZ04_TSL3Sh(IStrategy):
    ...
    buy_condition_0_enable = CategoricalParameter(
        ...
        default=True,
        space="buy",
        optimize=sh.get_space("buy_cond"),
        load=True,
    )
    ...
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(
        0.7, 1.1, default=0.989, space="buy", optimize=sh.get_space("cond1"), load=True
    )
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(
        0.7, 1.1, default=0.982, space="buy", optimize=sh.get_space("cond2"), load=True
    )
    ...
    trade_time = IntParameter(
        25, 65, default=35, space="sell", optimize=sh.get_space("misc"), load=True
    )
    rsi_1h_val = IntParameter(
        25, 45, default=32, space="sell", optimize=sh.get_space("misc"), load=True
    )
    ...
    base_nb_candles_sell = IntParameter(
        5, 80, default=49, space="sell", optimize=sh.get_space("ma"), load=True
    )
    high_offset = DecimalParameter(
        0.99, 1.1, default=1.006, space="sell", optimize=sh.get_space("ma"), load=True
    )
