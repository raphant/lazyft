...
Best result:
   ...
   173/500:    279 trades. Avg profit   0.49%. Total profit  113.32837209 USDT ( 135.86Σ%). Avg duration 898.3 min. Objective: -23.53064
    ...
    sell_params = {
        ...
        'sell-cmf-value': 0.75011,
        'sell-fast-enabled': False,
        'sell-fastd-value': 84,
        'sell-fastk-value': 80,
        'sell-rsi-enabled': True,
        'sell-rsi-value': 79.10041,
...
class BBRSICCI5m(IStrategy):
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions = [
            dataframe['rsi'] > 79.10041,
            crossed_above_k_or_d,
            dataframe['close'] > dataframe['bb_middleband_2'],
            dataframe['volume'] > 0,
            dataframe['cmf'] > 0.75011,
        ]
