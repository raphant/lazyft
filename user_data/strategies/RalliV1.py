...
class RalliV1(IStrategy):
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        if (
            ...
            and current_time - timedelta(minutes=140) > trade.open_date_utc
        ):
            return -0.005
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["ema_14"] = ta.EMA(dataframe, period=14)
        dataframe["sma_9"] = ta.SMA(dataframe, period=9)
        dataframe["ema_9"] = ta.EMA(dataframe, period=9)
        # Elliot
