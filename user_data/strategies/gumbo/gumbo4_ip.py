...
from freqtradestrategy import merge_informative_pair, IStrategy
...
config_data = {
    "minimal_roi": {
        "0": 0.05337628440384501,
        "3": 0.009553956115059553,
        "14": 0.005368516664653366,
        "36": 0,
    },
    "stoploss": -0.31328843742398466,
    "trailing_stop": True,
    "trailing_stop_positive": 0.1384794293329078,
    "trailing_stop_positive_offset": 0.23078419829569619,
    "trailing_only_offset_is_reached": False,
}


class Gumbo4Ip(IStrategy):
    """
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(dataframe['rsi_1d'] < 33.33)
