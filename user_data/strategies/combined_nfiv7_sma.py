...
##     exit_sell_signal must set to true (or not set at all).                                             ##
...
class Combined_NFIv7_SMA(IStrategy):
    ...
    buy_01_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="26", space="buy", optimize=False, load=True
    )
    ...
    buy_01_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="200", space="buy", optimize=False, load=True
    )
    ...
    buy_01_protection__safe_dips_type = CategoricalParameter(
        ["10", "50", "100"], default="80", space="buy", optimize=False, load=True
    )
    buy_01_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=False, load=True
    )
    buy_01_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="70", space="buy", optimize=False, load=True
    )
    buy_01_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="24", space="buy", optimize=False, load=True
    )
    ...
    buy_03_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="100", space="buy", optimize=False, load=True
    )
    buy_03_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="36", space="buy", optimize=False, load=True
    )
    ...
    buy_04_protection__safe_dips_type = CategoricalParameter(
        ["10", "50", "100"], default="40", space="buy", optimize=False, load=True
    )
    buy_04_protection__safe_pump = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=False, load=True
    )
    buy_04_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="110", space="buy", optimize=False, load=True
    )
    buy_04_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"], default="48", space="buy", optimize=False, load=True
    )
    ...
    buy_05_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="20", space="buy", optimize=False, load=True
    )
    ...
    buy_07_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"], default="12", space="buy", optimize=False, load=True
    )
    ...
    buy_08_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="120", space="buy", optimize=False, load=True
    )
    ...
    buy_16_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"], default="50", space="buy", optimize=False, load=True
    )
    ...
    buy_18_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"], default="60", space="buy", optimize=False, load=True
    )
    ...
    buy_21_protection__safe_dips_type = CategoricalParameter(
        ["10", "50", "100"], default="90", space="buy", optimize=False, load=True
    )
    ...
    buy_condition_26_enable = CategoricalParameter(
        [True, False], default=True, space="buy", optimize=False, load=True
    )
    ...
    buy_26_protection__ema_fast = CategoricalParameter(
        [True, False],
        default=False,
        space="buy",
        optimize=buy_26_protection__optimize,
        load=True,
    )
    buy_26_protection__ema_fast_len = CategoricalParameter(
        ["26", "50", "100", "200"],
        default="50",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__ema_slow = CategoricalParameter(
        [True, False],
        default=True,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__ema_slow_len = CategoricalParameter(
        ["26", "50", "100", "200"],
        default="100",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__close_above_ema_fast = CategoricalParameter(
        [True, False],
        default=True,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__close_above_ema_fast_len = CategoricalParameter(
        ["12", "20", "26", "50", "100", "200"],
        default="50",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__close_above_ema_slow = CategoricalParameter(
        [True, False],
        default=True,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__close_above_ema_slow_len = CategoricalParameter(
        ["15", "50", "200"],
        default="200",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__sma200_rising = CategoricalParameter(
        [True, False],
        default=False,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="30",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__sma200_1h_rising = CategoricalParameter(
        [True, False],
        default=False,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"],
        default="50",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__safe_dips = CategoricalParameter(
        [True, False],
        default=True,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__safe_dips_type = CategoricalParameter(
        ["10", "50", "100"],
        default="10",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__safe_pump = CategoricalParameter(
        [True, False],
        default=True,
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__safe_pump_type = CategoricalParameter(
        ["10", "50", "100"],
        default="100",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_26_protection__safe_pump_period = CategoricalParameter(
        ["24", "36", "48"],
        default="48",
        space="buy",
        optimize=buy_26_protection__optimize,
    ...
    buy_min_inc_1 = DecimalParameter(
        0.01, 0.05, default=0.022, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_1 = DecimalParameter(
        20.0, 40.0, default=36.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_mfi_2 = DecimalParameter(
        30.0, 56.0, default=49.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ema_rel_3 = DecimalParameter(
        0.97, 0.999, default=0.986, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_ema_rel_5 = DecimalParameter(
        0.97, 0.999, default=0.944, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_7 = DecimalParameter(
        24.0, 50.0, default=37.0, space="buy", decimals=1, optimize=False, load=True
    )

    buy_volume_8 = DecimalParameter(
        1.0, 6.0, default=2.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_8 = DecimalParameter(
        16.0, 30.0, default=29.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_tail_diff_8 = DecimalParameter(
        3.0, 10.0, default=3.5, space="buy", decimals=1, optimize=False, load=True
    )

    buy_ma_offset_9 = DecimalParameter(
        0.91, 0.94, default=0.922, space="buy", decimals=3, optimize=False, load=True
    )
    buy_bb_offset_9 = DecimalParameter(
        0.96, 0.98, default=0.942, space="buy", decimals=3, optimize=False, load=True
    )
    buy_rsi_1h_min_9 = DecimalParameter(
        26.0, 40.0, default=30.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_mfi_9 = DecimalParameter(
        36.0, 56.0, default=50.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_1h_10 = DecimalParameter(
        20.0, 40.0, default=37.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.01, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_11 = DecimalParameter(
        34.0, 50.0, default=48.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_mfi_11 = DecimalParameter(
        30.0, 46.0, default=36.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_12 = DecimalParameter(
        1.0, 6.0, default=1.8, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-11.4, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_15 = DecimalParameter(
        20.0, 36.0, default=28.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_ema_rel_15 = DecimalParameter(
        0.97, 0.999, default=0.988, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_16 = DecimalParameter(
        26.0, 50.0, default=31.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_ewo_16 = DecimalParameter(
        2.0, 6.0, default=2.8, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-12.8, space="buy", decimals=1, optimize=False, load=True
    )

    buy_rsi_18 = DecimalParameter(
        16.0, 32.0, default=26.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_chop_min_19 = DecimalParameter(
        20.0, 60.0, default=24.1, space="buy", decimals=1, optimize=False, load=True
    )

    buy_rsi_20 = DecimalParameter(
        20.0, 36.0, default=27.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_20 = DecimalParameter(
        14.0, 30.0, default=20.0, space="buy", decimals=1, optimize=False, load=True
    )

    buy_rsi_21 = DecimalParameter(
        10.0, 28.0, default=23.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_21 = DecimalParameter(
        18.0, 40.0, default=24.0, space="buy", decimals=1, optimize=False, load=True
    )

    buy_volume_22 = DecimalParameter(
        0.5, 6.0, default=3.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ma_offset_22 = DecimalParameter(
        0.93, 0.98, default=0.94, space="buy", decimals=3, optimize=False, load=True
    )
    buy_ewo_22 = DecimalParameter(
        2.0, 10.0, default=4.2, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_22 = DecimalParameter(
        26.0, 56.0, default=37.0, space="buy", decimals=1, optimize=False, load=True
    )

    buy_bb_offset_23 = DecimalParameter(
        0.97, 1.0, default=0.987, space="buy", decimals=3, optimize=False, load=True
    )
    buy_ewo_23 = DecimalParameter(
        2.0, 10.0, default=7.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_23 = DecimalParameter(
        20.0, 40.0, default=30.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_23 = DecimalParameter(
        60.0, 80.0, default=70.0, space="buy", decimals=1, optimize=False, load=True
    )

    buy_24_rsi_max = DecimalParameter(
        26.0, 60.0, default=60.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_26_zema_low_offset = DecimalParameter(
        ...
        default=0.93,
        space="buy",
        optimize=buy_26_parameters__optimize,
        load=True,
    )
    ...
    sell_rsi_bb_1 = DecimalParameter(
        60.0, 80.0, default=79.5, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_rsi_1h_7 = DecimalParameter(
        80.0, 95.0, default=81.7, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_profit_0 = DecimalParameter(
        0.01, 0.1, default=0.01, space="sell", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_rsi_6 = DecimalParameter(
        38.0, 55.0, default=48.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_0 = DecimalParameter(
        28.0, 40.0, default=35.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_trail_profit_min_1 = DecimalParameter(
        0.1, 0.2, default=0.16, space="sell", decimals=2, optimize=False, load=True
    )
    sell_trail_profit_max_1 = DecimalParameter(
        0.4, 0.7, default=0.6, space="sell", decimals=2, optimize=False, load=True
    )
    sell_trail_down_1 = DecimalParameter(
        0.01, 0.08, default=0.03, space="sell", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_stoploss_under_rel_1 = DecimalParameter(
        0.001, 0.02, default=0.004, space="sell", optimize=False, load=True
    )
    ...
    sell_custom_stoploss_long_recover_1 = DecimalParameter(
        0.05, 0.15, default=0.1, space="sell", optimize=False, load=True
    )
    ...
    sell_custom_recover_profit_1 = DecimalParameter(
        0.01, 0.06, default=0.04, space="sell", decimals=3, optimize=False, load=True
    )
        ...
        **kwargs,
        ...
        if last_candle is not None:
            ...
            #     return 'signal_profit_p_s_1'
                ...
                (
                    self.sell_custom_stoploss_long_profit_min_1.value
                    < current_profit
                    < self.sell_custom_stoploss_long_profit_max_1.value
                )
                & (
                    current_profit
                    > (-max_loss + self.sell_custom_stoploss_long_recover_1.value)
                )
                & (last_candle["close"] < last_candle["ema_200"])
                & (
                    last_candle["rsi"]
                    > last_candle["rsi_1h"]
                    + self.sell_custom_stoploss_long_rsi_diff_1.value
                )
                & (last_candle["sma_200_dec_24"])
                & (current_time - timedelta(minutes=1200) > trade.open_date_utc)
            ):
                ...
                & (
                    current_profit
                    > (-max_loss + self.sell_custom_stoploss_long_recover_2.value)
                )
                & (last_candle["close"] < last_candle["ema_200"])
                & (
                    last_candle["rsi"]
                    > last_candle["rsi_1h"]
                    + self.sell_custom_stoploss_long_rsi_diff_2.value
                )
                & (last_candle["sma_200_dec_24"])
                & (current_time - timedelta(minutes=1200) > trade.open_date_utc)
            ):
            ...
            # Recover
            elif (max_loss > self.sell_custom_recover_min_loss_1.value) & (
                current_profit > self.sell_custom_recover_profit_1.value
            ):
                return "signal_profit_r_1"

            elif (
                (max_loss > self.sell_custom_recover_min_loss_2.value)
                & (
                    self.sell_custom_recover_profit_max_2.value
                    > current_profit
                    > self.sell_custom_recover_profit_min_2.value
                )
                & (last_candle["rsi"] < self.sell_custom_recover_rsi_2.value)
            ):
                return "signal_profit_r_2"

            # Take profit for long duration trades
            elif (
                self.sell_custom_long_profit_min_1.value
                < current_profit
                < self.sell_custom_long_profit_max_1.value
            ) & (
                current_time
                - timedelta(minutes=self.sell_custom_long_duration_min_1.value)
                > trade.open_date_utc
            ):
    ...
    def safe_pump(
        ...
        """
        df = dataframe.copy()
        return (df[f"oc_pct_change_{length}"] < thresh) | (
    ...
    def informative_1h_indicators(
        ...
        informative_1h["safe_pump_24_10"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_10_24.value,
            self.buy_pump_pull_threshold_10_24.value,
        )
        informative_1h["safe_pump_36_10"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_10_36.value,
            self.buy_pump_pull_threshold_10_36.value,
        )
        informative_1h["safe_pump_48_10"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_10_48.value,
            self.buy_pump_pull_threshold_10_48.value,
        )

        informative_1h["safe_pump_24_20"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_20_24.value,
            self.buy_pump_pull_threshold_20_24.value,
        )
        informative_1h["safe_pump_36_20"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_20_36.value,
            self.buy_pump_pull_threshold_20_36.value,
        )
        informative_1h["safe_pump_48_20"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_20_48.value,
            self.buy_pump_pull_threshold_20_48.value,
        )

        informative_1h["safe_pump_24_30"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_30_24.value,
            self.buy_pump_pull_threshold_30_24.value,
        )
        informative_1h["safe_pump_36_30"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_30_36.value,
            self.buy_pump_pull_threshold_30_36.value,
        )
        informative_1h["safe_pump_48_30"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_30_48.value,
            self.buy_pump_pull_threshold_30_48.value,
        )

        informative_1h["safe_pump_24_40"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_40_24.value,
            self.buy_pump_pull_threshold_40_24.value,
        )
        informative_1h["safe_pump_36_40"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_40_36.value,
            self.buy_pump_pull_threshold_40_36.value,
        )
        informative_1h["safe_pump_48_40"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_40_48.value,
            self.buy_pump_pull_threshold_40_48.value,
        )

        informative_1h["safe_pump_24_50"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_50_24.value,
            self.buy_pump_pull_threshold_50_24.value,
        )
        informative_1h["safe_pump_36_50"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_50_36.value,
            self.buy_pump_pull_threshold_50_36.value,
        )
        informative_1h["safe_pump_48_50"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_50_48.value,
            self.buy_pump_pull_threshold_50_48.value,
        )

        informative_1h["safe_pump_24_60"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_60_24.value,
            self.buy_pump_pull_threshold_60_24.value,
        )
        informative_1h["safe_pump_36_60"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_60_36.value,
            self.buy_pump_pull_threshold_60_36.value,
        )
        informative_1h["safe_pump_48_60"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_60_48.value,
            self.buy_pump_pull_threshold_60_48.value,
        )

        informative_1h["safe_pump_24_70"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_70_24.value,
            self.buy_pump_pull_threshold_70_24.value,
        )
        informative_1h["safe_pump_36_70"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_70_36.value,
            self.buy_pump_pull_threshold_70_36.value,
        )
        informative_1h["safe_pump_48_70"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_70_48.value,
            self.buy_pump_pull_threshold_70_48.value,
        )

        informative_1h["safe_pump_24_80"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_80_24.value,
            self.buy_pump_pull_threshold_80_24.value,
        )
        informative_1h["safe_pump_36_80"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_80_36.value,
            self.buy_pump_pull_threshold_80_36.value,
        )
        informative_1h["safe_pump_48_80"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_80_48.value,
            self.buy_pump_pull_threshold_80_48.value,
        )

        informative_1h["safe_pump_24_90"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_90_24.value,
            self.buy_pump_pull_threshold_90_24.value,
        )
        informative_1h["safe_pump_36_90"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_90_36.value,
            self.buy_pump_pull_threshold_90_36.value,
        )
        informative_1h["safe_pump_48_90"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_90_48.value,
            self.buy_pump_pull_threshold_90_48.value,
        )

        informative_1h["safe_pump_24_100"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_100_24.value,
            self.buy_pump_pull_threshold_100_24.value,
        )
        informative_1h["safe_pump_36_100"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_100_36.value,
            self.buy_pump_pull_threshold_100_36.value,
        )
        informative_1h["safe_pump_48_100"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_100_48.value,
            self.buy_pump_pull_threshold_100_48.value,
        )

        informative_1h["safe_pump_24_110"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_110_24.value,
            self.buy_pump_pull_threshold_110_24.value,
        )
        informative_1h["safe_pump_36_110"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_110_36.value,
            self.buy_pump_pull_threshold_110_36.value,
        )
        informative_1h["safe_pump_48_110"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_110_48.value,
            self.buy_pump_pull_threshold_110_48.value,
        )

        informative_1h["safe_pump_24_120"] = self.safe_pump(
            informative_1h,
            24,
            self.buy_pump_threshold_120_24.value,
            self.buy_pump_pull_threshold_120_24.value,
        )
        informative_1h["safe_pump_36_120"] = self.safe_pump(
            informative_1h,
            36,
            self.buy_pump_threshold_120_36.value,
            self.buy_pump_pull_threshold_120_36.value,
        )
        informative_1h["safe_pump_48_120"] = self.safe_pump(
            informative_1h,
            48,
            self.buy_pump_threshold_120_48.value,
            self.buy_pump_pull_threshold_120_48.value,
        )
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["safe_dips_10"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_10_1.value,
            self.buy_dip_threshold_10_2.value,
            self.buy_dip_threshold_10_3.value,
            self.buy_dip_threshold_10_4.value,
        )
        dataframe["safe_dips_20"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_20_1.value,
            self.buy_dip_threshold_20_2.value,
            self.buy_dip_threshold_20_3.value,
            self.buy_dip_threshold_20_4.value,
        )
        dataframe["safe_dips_30"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_30_1.value,
            self.buy_dip_threshold_30_2.value,
            self.buy_dip_threshold_30_3.value,
            self.buy_dip_threshold_30_4.value,
        )
        dataframe["safe_dips_40"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_40_1.value,
            self.buy_dip_threshold_40_2.value,
            self.buy_dip_threshold_40_3.value,
            self.buy_dip_threshold_40_4.value,
        )
        dataframe["safe_dips_50"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_50_1.value,
            self.buy_dip_threshold_50_2.value,
            self.buy_dip_threshold_50_3.value,
            self.buy_dip_threshold_50_4.value,
        )
        dataframe["safe_dips_60"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_60_1.value,
            self.buy_dip_threshold_60_2.value,
            self.buy_dip_threshold_60_3.value,
            self.buy_dip_threshold_60_4.value,
        )
        dataframe["safe_dips_70"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_70_1.value,
            self.buy_dip_threshold_70_2.value,
            self.buy_dip_threshold_70_3.value,
            self.buy_dip_threshold_70_4.value,
        )
        dataframe["safe_dips_80"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_80_1.value,
            self.buy_dip_threshold_80_2.value,
            self.buy_dip_threshold_80_3.value,
            self.buy_dip_threshold_80_4.value,
        )
        dataframe["safe_dips_90"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_90_1.value,
            self.buy_dip_threshold_90_2.value,
            self.buy_dip_threshold_90_3.value,
            self.buy_dip_threshold_90_4.value,
        )
        dataframe["safe_dips_100"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_100_1.value,
            self.buy_dip_threshold_100_2.value,
            self.buy_dip_threshold_100_3.value,
            self.buy_dip_threshold_100_4.value,
        )
        dataframe["safe_dips_110"] = self.safe_dips(
            dataframe,
            self.buy_dip_threshold_110_1.value,
            self.buy_dip_threshold_110_2.value,
            self.buy_dip_threshold_110_3.value,
            self.buy_dip_threshold_110_4.value,
        )
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        buy_04_logic.append(
            dataframe["close"]
            < self.buy_bb20_close_bblowerband_4.value * dataframe["bb20_2_low"]
        )
        buy_04_logic.append(
            dataframe["volume"]
        ...
        if self.buy_26_protection__ema_fast.value:
            buy_26_protections.append(
                dataframe[f"ema_{self.buy_26_protection__ema_fast_len.value}"]
                > dataframe["ema_200"]
            )
        if self.buy_26_protection__ema_slow.value:
            buy_26_protections.append(
                dataframe[f"ema_{self.buy_26_protection__ema_slow_len.value}_1h"]
                > dataframe["ema_200_1h"]
            )
        if self.buy_26_protection__close_above_ema_fast.value:
            buy_26_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_26_protection__close_above_ema_fast_len.value}"
                ]
            )
        if self.buy_26_protection__close_above_ema_slow.value:
            buy_26_protections.append(
                dataframe["close"]
                > dataframe[
                    f"ema_{self.buy_26_protection__close_above_ema_slow_len.value}_1h"
                ]
            )
        if self.buy_26_protection__sma200_rising.value:
            buy_26_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(
                    int(self.buy_26_protection__sma200_rising_val.value)
                )
            )
        if self.buy_26_protection__sma200_1h_rising.value:
            buy_26_protections.append(
                dataframe["sma_200_1h"]
                > dataframe["sma_200_1h"].shift(
                    int(self.buy_26_protection__sma200_1h_rising_val.value)
                )
            )
        if self.buy_26_protection__safe_dips.value:
            buy_26_protections.append(
                dataframe[f"safe_dips_{self.buy_26_protection__safe_dips_type.value}"]
            )
        if self.buy_26_protection__safe_pump.value:
            buy_26_protections.append(
                dataframe[
                    f"safe_pump_{self.buy_26_protection__safe_pump_period.value}_{self.buy_26_protection__safe_pump_type.value}_1h"
                ]
            )
        # Non-Standard protections (add below)
        ...
        buy_26_logic.append(
            dataframe["close"] < (dataframe["zema"] * self.buy_26_zema_low_offset.value)
        )
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            (
                ...
                & (
                    dataframe["close"]
                    > dataframe["bb20_2_upp_1h"] * self.sell_bb_relative_8.value
                )
                & (dataframe["volume"] > 0)
            )
        )
