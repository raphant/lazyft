"""
    No sell config. Used for hyper-opting buy only.

2020-08-02 14:24:21,952 - freqtrade.optimize.hyperopt - INFO - 500 epochs saved to '/home/genius/ft_userdata/freqtrade/user_data/hyperopt_results/hyperopt_results.pickle'.

Best result:

   295/500:    247 trades. Avg profit   0.52%. Total profit  106.86993310 USDT ( 128.12Σ%). Avg duration 1019.3 min. Objective: -8.29188


    # Buy hyperspace params:
    buy_params = {
     'rsi-enabled': False, 'rsi-value': 34, 'trigger': 'bb_lowerband_2'
    }
...
class BBRSICCI5m(IStrategy):
    ...
    minimal_roi = {"0": 0.07615, "34": 0.05605, "66": 0.03988, "160": 0}
