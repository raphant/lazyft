...
class BB_RPB_TSL(IStrategy):
    ...
    buy_ewo2_cti = DecimalParameter(
        -0.9, -0.0, default=-0.5, optimize=is_optimize_ewo2_protection
    )
    buy_ewo2_r14 = DecimalParameter(
        -100, -44, default=-60, optimize=is_optimize_ewo2_protection
    )
    ...
    buy_clucha_close_bblower = DecimalParameter(
        0.001, 0.05, default=0.03669, optimize=is_optimize_clucha
    )
    ...
    buy_nfix_39_cti = DecimalParameter(
        -0.9, -0.0, default=-0.5, optimize=is_optimize_nfix_39_protection
    )
    buy_nfix_39_r14 = DecimalParameter(
        -100, -44, default=-60, optimize=is_optimize_nfix_39_protection
    )
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        is_sqzOff = (dataframe['bb_lowerband2'] < dataframe['kc_lowerband']) & (
        ...
        is_clucHA = (dataframe['rocr_1h'] > self.buy_clucha_rocr_1h.value) & (
            ...
            | (
                ...
                & (
                    dataframe['ha_close']
                    < self.buy_clucha_close_bblower.value * dataframe['bb_lowerband2']
                )
            )
        )
