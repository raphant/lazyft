...
class ElliotV8_original_ichiv2_sh(IStrategy):
    ...
    rsi_buy = IntParameter(
        30, 70, default=buy_params["rsi_buy"], space="buy", optimize=sh.get_space("rsi")
    )
...
class ElliotV8_original_ichiv2_shRest(BaseRestStrategy, ElliotV8_original_ichiv2_sh):
    rest_strategy_name = "ElliotV8_original_ichiv2_sh"
    backtest_days = 10
    hyperopt_days = 5
    hyperopt_epochs = 65
    min_avg_profit = 0.01
