...
class NostalgiaForInfinityNext_ChangeToTower_V2(IStrategy):
    INTERFACE_VERSION = 2
    ...
    buy_params = {
        ...
        "base_nb_candles_bearish_buy": 68,
        "base_nb_candles_bullish_buy": 75,
        "ewo_high": 9.675,
        "ewo_low": -14.953,
        "low_offset_bearish": 0.97,
        "low_offset_bullish": 0.979,
        "pmaxmultiplier": 27,
        "rsi_buy_bearish": 65,
        "rsi_buy_bullish": 66,
    ...
    sell_params = {
        ...
        # Enable/Disable conditions
        "atr_multiplier": 2.83,
        "atr_rolling_length": 1,
        "base_nb_candles_bearish_sell": 21,
        "base_nb_candles_bullish_sell": 21,
        "high_offset_bearish": 1.012,
        "high_offset_bullish": 1.039,
    ...
    buy_rsi_1h_diff_2 = DecimalParameter(
        30.0, 50.0, default=38.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_bb40_closedelta_close_3 = DecimalParameter(
        0.01, 0.03, default=0.022, space="buy", optimize=False, load=True
    )
    ...
    buy_cti_3 = DecimalParameter(
        -0.99, -0.5, default=-0.9, space="buy", decimals=2, optimize=False, load=True
    )

    buy_bb20_close_bblowerband_4 = DecimalParameter(
        0.96, 0.99, default=0.976, space="buy", optimize=False, load=True
    )
    buy_bb20_volume_4 = DecimalParameter(
        1.0, 20.0, default=3.0, space="buy", decimals=2, optimize=False, load=True
    )
    ...
    buy_volume_5 = DecimalParameter(
        0.6, 6.0, default=1.9, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ema_open_mult_7 = DecimalParameter(
        0.02, 0.04, default=0.031, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        20.0, 50.0, default=30.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_8 = DecimalParameter(
        40.0, 66.0, default=54.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_25_rsi_14 = DecimalParameter(
    ...
    buy_27_wr_max = DecimalParameter(
        95, 99, default=95.4, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_bullish_trigger = CategoricalParameter(
        ma_types.keys(), default="hull", space="buy", optimize=False
    )
    buy_bearish_trigger = CategoricalParameter(
        ma_types.keys(), default="zlema", space="buy", optimize=False
    )

    sell_bullish_trigger = CategoricalParameter(
        ma_types.keys(), default="hull", space="sell", optimize=False
    )
    sell_bearish_trigger = CategoricalParameter(
        ma_types.keys(), default="zlema", space="sell", optimize=False
    )
    ...
    base_nb_candles_bullish_sell = IntParameter(
        10, 30, default=15, space="sell", optimize=True
    )
    base_nb_candles_bearish_sell = IntParameter(
        10, 30, default=15, space="sell", optimize=True
    )
    ...
    high_offset_bullish = DecimalParameter(
        1.01, 1.06, default=1.012, space="sell", optimize=True
    )
    high_offset_bearish = DecimalParameter(
        0.98, 1.04, default=0.98, space="sell", optimize=True
    )
    ...
    atr_multiplier = DecimalParameter(
        1.0, 4.0, default=3.0, space="sell", decimals=2, optimize=True, load=True
    )
    ...
    rsi_buy_bullish = IntParameter(
        30, 70, default=50, space="buy", optimize=True, load=True
    )
    rsi_buy_bearish = IntParameter(
        30, 70, default=50, space="buy", optimize=True, load=True
    )
    ...
    def sell_over_main(self, current_profit: float, last_candle) -> tuple:
        if last_candle["close"] > last_candle["ema_200"]:
            if current_profit > self.sell_custom_profit_11.value:
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_7.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_6.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_5.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_4.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_3.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_2.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_1.value) & (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi"] < self.sell_custom_rsi_0.value) & (
                    last_candle["cmf"] < 0.0
                ):
    ...
    def sell_under_main(self, current_profit: float, last_candle) -> tuple:
        if last_candle["close"] < last_candle["ema_200"]:
            if current_profit > self.sell_custom_under_profit_11.value:
                ...
                if (last_candle["rsi"] < self.sell_custom_under_rsi_0.value) & (
                    last_candle["cmf"] < 0.0
                ):
    ...
    def sell_trail_main(
        ...
        if (
            ...
            & (max_profit > (current_profit + self.sell_trail_down_4.value))
    ...
    def sell_under_min(self, current_profit: float, last_candle) -> tuple:
        if (last_candle["moderi_96"]) == False:
            # Downtrend
            if (
                (current_profit > self.sell_custom_profit_under_profit_1.value)
    ...
    def sell_stoploss(
        ...
        # Under EMA200, pair & BTC negative, low max rate
            ...
            (-0.1 > current_profit > -0.14)
            & (last_candle["btc_not_downtrend_1h"] == False)
            & (last_candle["moderi_32"] == False)
            & (last_candle["moderi_64"] == False)
            & (max_profit < 0.005)
            & (max_loss < 0.14)
            & (last_candle["sma_200_dec_24"])
            & (last_candle["cmf"] < -0.0)
        ...
        # Under EMA200, pair & BTC negative, CTI, Elder Ray Index negative, normal max rate
            ...
            & (last_candle["sma_200_dec_24"])
            & (last_candle["sma_200_dec_20_1h"])
            & (last_candle["cmf"] < -0.45)
            & (last_candle["close"] < last_candle["ema_200"])
            & (last_candle["ema_25"] < last_candle["ema_50"])
            & (last_candle["cti"] < -0.8)
            & (last_candle["r_480"] < -97.0)
        ):
    ...
    def sell_recover(
        ...
        if (max_loss > self.sell_custom_recover_min_loss_1.value) & (
    ...
    def sell_r_2(self, current_profit: float, last_candle) -> tuple:
        if 0.02 > current_profit > 0.012:
            if (
                ...
                & (last_candle["rsi"] > 79.0)
                & (last_candle["stochrsi_fastk_96"] > 99.0)
                & (last_candle["stochrsi_fastd_96"] > 99.0)
            ):
    ...
    def sell_quick_mode(
        ...
        if (
            (buy_signal_candle["buy_condition_32"] == 1)
            or (buy_signal_candle["buy_condition_33"] == 1)
            or (buy_signal_candle["buy_condition_34"] == 1)
        ):
        ...
        if (
            (buy_signal_candle["buy_condition_35"] == 1)
            or (buy_signal_candle["buy_condition_36"] == 1)
            or (buy_signal_candle["buy_condition_37"] == 1)
            or (buy_signal_candle["buy_condition_38"] == 1)
        ):
            if (
                last_candle["close"]
                < last_candle[f"atr_high{self.atr_rolling_length.value}"]
            ) & (
                last_candle["close"]
                > last_candle[f"atr_high{self.atr_rolling_length.value}"]
            ):
                return True, "ATR_stoploss"

            if current_profit > 0.0:
                if (
                    (
                        last_candle[
                            f"pm_{pmaxperiod}_{self.pmaxmultiplier.value}_{self.pmaxlength.value}_{pmaxtype}"
                        ]
                        <= last_candle[f"mavalue{self.pmaxlength.value}"]
                    )
                    & (
                        (
                            last_candle["close"]
                            > last_candle[
                                f"{self.ma_type_index_4.value}_ma_sell_bullish{self.base_nb_candles_bullish_sell.value}"
                            ]
                            * self.high_offset_bullish.value
                        )
                    )
                ) or (
                    (
                    ...
                    & (
                        (
                            last_candle["close"]
                            > last_candle[
                                f"{self.ma_type_index_5.value}_ma_sell_bearish{self.base_nb_candles_bearish_sell.value}"
                            ]
                            * self.high_offset_bearish.value
                        )
                    )
                ):
                    return True, "offset_sell"
                if (
                    (last_candle["tsi_s"] <= last_candle["tsi_ema_s"])
                    & (secondlast_candle["tsi_s"] > secondlast_candle["tsi_ema_s"])
                    & (current_profit > 0.01)
                ):
                    return "TSI_sell"
            ...
            if (current_profit >= 0.005) & (
                ...
                if (last_candle["tsi_f"] <= last_candle["tsi_ema_f"]) & (
                    secondlast_candle["tsi_f"] > secondlast_candle["tsi_ema_f"]
                ):
                    return True, "TSI_dn_sell"
    ...
    def custom_sell(
        ...
        **kwargs,
        ...
        secondlast_candle = previous_candle_1
        ...
        if (
            ...
            & (last_candle["rsi"] > self.sell_rsi_bb_1.value)
            & (last_candle["close"] > last_candle["bb20_2_upp"])
            & (previous_candle_1["close"] > previous_candle_1["bb20_2_upp"])
            & (previous_candle_2["close"] > previous_candle_2["bb20_2_upp"])
            & (previous_candle_3["close"] > previous_candle_3["bb20_2_upp"])
            & (previous_candle_4["close"] > previous_candle_4["bb20_2_upp"])
        ...
        # Sell signal 2
            ...
            & (last_candle["rsi"] > self.sell_rsi_bb_2.value)
            & (last_candle["close"] > last_candle["bb20_2_upp"])
            & (previous_candle_1["close"] > previous_candle_1["bb20_2_upp"])
            & (previous_candle_2["close"] > previous_candle_2["bb20_2_upp"])
        ):
        ...
        # Sell signal 4
            ...
            & (last_candle["rsi"] > self.sell_dual_rsi_rsi_4.value)
            & (last_candle["rsi_1h"] > self.sell_dual_rsi_rsi_1h_4.value)
        ):
        ...
        # Sell signal 6
            ...
            & (last_candle["close"] < last_candle["ema_200"])
            & (last_candle["close"] > last_candle["ema_50"])
            & (last_candle["rsi"] > self.sell_rsi_under_6.value)
        ):
        ...
        # Sell signal 7
            ...
            & (last_candle["rsi_1h"] > self.sell_rsi_1h_7.value)
            & (last_candle["crossed_below_ema_12_26"])
        ):
            return "sell_signal_7"

        # Sell signal 8
        elif self.sell_condition_8_enable.value & (
            last_candle["close"]
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for mult in self.pmaxmultiplier.range:
            for leng in self.pmaxlength.range:
                ...
                dataframe[f"pm_{pmaxperiod}_{mult}_{leng}_{pmaxtype}"] = pmdf[
                    f"pm_{pmaxperiod}_{mult}_{leng}_{pmaxtype}"
                ]
                dataframe[f"mavalue{leng}"] = ta.EMA(
                    dataframe["source"], timeperiod=leng
                )

        for mval in self.ma_type_index_1.range:
            for val in self.base_nb_candles_bullish_buy.range:
                dataframe[f"{mval}_ma_buy_bullish{val}"] = ma_types[
                    list(ma_types)[mval]
                ](dataframe, timeperiod=val)

        for mval in self.ma_type_index_2.range:
            for val in self.base_nb_candles_bearish_buy.range:
                dataframe[f"{mval}_ma_buy_bearish{val}"] = ma_types[
                    list(ma_types)[mval]
                ](dataframe, timeperiod=val)

        for mval in self.ma_type_index_4.range:
            for val in self.base_nb_candles_bullish_sell.range:
                dataframe[f"{mval}_ma_sell_bullish{val}"] = ma_types[
                    list(ma_types)[mval]
                ](dataframe, timeperiod=val)

        for mval in self.ma_type_index_5.range:
            for val in self.base_nb_candles_bearish_sell.range:
                dataframe[f"{mval}_ma_sell_bearish{val}"] = ma_types[
                    list(ma_types)[mval]
                ](dataframe, timeperiod=val)

        dataframe["tsi_s"] = tsi(dataframe, window_slow=20, window_fast=5)
        dataframe["tsi_ema_s"] = ta.EMA(dataframe["tsi_s"], timeperiod=5)

        dataframe["tsi_f"] = tsi(dataframe, window_slow=4, window_fast=2)
        ...
        for i in self.atr_rolling_length.range:
            dataframe[f"atr_high{i}"] = (
                (dataframe["high"] - (dataframe["atr"] * self.atr_multiplier.value))
                .rolling(i)
                .max()
            )
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.config["runmode"].value in ("live", "dry_run"):
            not_empty_volume = (
                dataframe["volume"].rolling(window=72, min_periods=72).count().notna()
            )
        else:
            not_empty_volume = (
                dataframe["volume"]
                .rolling(
                    ...
                    min_periods=self.startup_candle_count,
                )
                .count()
                .notna()
            )
        ...
        # Buy Condition #1
        dataframe.loc[:, "buy_condition_1"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_1_enable"]:
            ...
            dataframe.loc[item_buy, "buy_condition_1"] = 1
            conditions.append(item_buy)

        # Buy Condition #2
        dataframe.loc[:, "buy_condition_2"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_2_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_2"] = 1
            conditions.append(item_buy)

        # Buy Condition #3
        dataframe.loc[:, "buy_condition_3"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_3_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[2].append(
                dataframe["close"]
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_3"] = 1
            conditions.append(item_buy)

        # Buy Condition #4
        dataframe.loc[:, "buy_condition_4"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_4_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_4"] = 1
            conditions.append(item_buy)

        # Buy Condition #5
        dataframe.loc[:, "buy_condition_5"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_5_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[4].append(
                dataframe["close"]
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_5"] = 1
            conditions.append(item_buy)

        # Buy Condition #6
        dataframe.loc[:, "buy_condition_6"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_6_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_6"] = 1
            conditions.append(item_buy)

        # Buy Condition #7
        dataframe.loc[:, "buy_condition_7"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_7_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_7"] = 1
            conditions.append(item_buy)

        # Buy Condition #8
        dataframe.loc[:, "buy_condition_8"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_8_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_8"] = 1
            conditions.append(item_buy)

        # Buy Condition #9
        dataframe.loc[:, "buy_condition_9"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_9_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_9"] = 1
            conditions.append(item_buy)

        # Buy Condition #10
        dataframe.loc[:, "buy_condition_10"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_10_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[9].append(
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_10"] = 1
            conditions.append(item_buy)

        # Buy Condition #11
        dataframe.loc[:, "buy_condition_11"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_11_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[10].append(
                dataframe["ema_50_1h"] > dataframe["ema_100_1h"]
            )
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_11"] = 1
            conditions.append(item_buy)

        # Buy Condition #12
        dataframe.loc[:, "buy_condition_12"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_12_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_12"] = 1
            conditions.append(item_buy)

        # Buy Condition #13
        dataframe.loc[:, "buy_condition_13"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_13_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[12].append(
                dataframe["ema_50_1h"] > dataframe["ema_100_1h"]
            )
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_13"] = 1
            conditions.append(item_buy)

        # Buy Condition #14
        dataframe.loc[:, "buy_condition_14"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_14_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_14"] = 1
            conditions.append(item_buy)

        # Buy Condition #15
        dataframe.loc[:, "buy_condition_15"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_15_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_15"] = 1
            conditions.append(item_buy)

        # Buy Condition #16
        dataframe.loc[:, "buy_condition_16"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_16_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_16"] = 1
            conditions.append(item_buy)

        # Buy Condition #17
        dataframe.loc[:, "buy_condition_17"] = 0
        # -----------------------------------------------------------------------------------------
        ...
        if self.buy_params["buy_condition_18_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_18"] = 1
            conditions.append(item_buy)

        # Buy Condition #19
        dataframe.loc[:, "buy_condition_19"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_19_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[18].append(
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_19"] = 1
            conditions.append(item_buy)

        # Buy Condition #20
        dataframe.loc[:, "buy_condition_20"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_20_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_20"] = 1
            conditions.append(item_buy)

        # Buy Condition #21
        dataframe.loc[:, "buy_condition_21"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_21_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_21"] = 1
            conditions.append(item_buy)

        # Buy Condition #22
        dataframe.loc[:, "buy_condition_22"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_22_enable"]:
            # Non-Standard protections (add below)
            buy_protection_list[21].append(
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_22"] = 1
            conditions.append(item_buy)

        # Buy Condition #23
        dataframe.loc[:, "buy_condition_23"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_23_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_23"] = 1
            conditions.append(item_buy)

        # Buy Condition #24
        dataframe.loc[:, "buy_condition_24"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_24_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_24"] = 1
            conditions.append(item_buy)

        # Buy Condition #25
        dataframe.loc[:, "buy_condition_25"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_25_enable"]:
            ...
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_25"] = 1
            conditions.append(item_buy)

        # Buy Condition #26
        dataframe.loc[:, "buy_condition_26"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_26_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_26"] = 1
            conditions.append(item_buy)

        # Buy Condition #27
        dataframe.loc[:, "buy_condition_27"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_27_enable"]:
            ...
            item_buy_logic.append(
                dataframe["rsi_1h"] + dataframe["rsi"] < self.buy_27_rsi_max.value
            )
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_27"] = 1
            conditions.append(item_buy)

        # Buy Condition #28
        dataframe.loc[:, "buy_condition_28"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_28_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_28"] = 1
            conditions.append(item_buy)

        # Buy Condition #29
        dataframe.loc[:, "buy_condition_29"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_29_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_29"] = 1
            conditions.append(item_buy)

        # Buy Condition #30
        dataframe.loc[:, "buy_condition_30"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_30_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_30"] = 1
            conditions.append(item_buy)

        # Buy Condition #31
        dataframe.loc[:, "buy_condition_31"] = 0
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_31_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_31"] = 1
            conditions.append(item_buy)

        # Buy Condition #32
        dataframe.loc[:, "buy_condition_32"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_32_enable"]:
            ...
            item_buy_logic.append(
                (dataframe["open"] - dataframe["close"]) / dataframe["close"] < 0.005
            )
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_32"] = 1
            conditions.append(item_buy)

        # Buy Condition #33
        dataframe.loc[:, "buy_condition_33"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_33_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_33"] = 1
            conditions.append(item_buy)

        # Buy Condition #34
        dataframe.loc[:, "buy_condition_34"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_34_enable"]:
            ...
            item_buy_logic.append(
                dataframe["volume"] < (dataframe["volume_mean_4"] * 1.1)
            )
            item_buy_logic.append(
                (dataframe["open"] - dataframe["close"]) / dataframe["close"] < 0.002
            )
            item_buy_logic.append(dataframe["close"] < dataframe["ema_13"] * 0.968)
            item_buy_logic.append(dataframe["ewo"] < -20.0)
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_34"] = 1
            conditions.append(item_buy)

        # Buy Condition #35
        dataframe.loc[:, "buy_condition_35"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_35_enable"]:
            ...
            item_buy_logic.append(
                ...
                <= dataframe[f"mavalue{self.pmaxlength.value}"]
            )
            item_buy_logic.append(
                dataframe["close"]
                < dataframe[
                    f"{self.ma_type_index_1.value}_ma_buy_bullish{self.base_nb_candles_bullish_buy.value}"
                ]
                * self.low_offset_bullish.value
            )
            item_buy_logic.append(dataframe["ewo"] > self.ewo_high.value)
            item_buy_logic.append(dataframe["rsi14"] < self.rsi_buy_bullish.value)
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_35"] = 1
            conditions.append(item_buy)

        # Buy Condition #36
        dataframe.loc[:, "buy_condition_36"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_36_enable"]:
            ...
            item_buy_logic.append(dataframe["ewo"] < self.ewo_low.value)
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_36"] = 1
            conditions.append(item_buy)

        # Buy Condition #37
        dataframe.loc[:, "buy_condition_37"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_37_enable"]:
            ...
            item_buy_logic.append(
                dataframe["close"]
                < dataframe[
                    f"{self.ma_type_index_2.value}_ma_buy_bearish{self.base_nb_candles_bearish_buy.value}"
                ]
                * self.low_offset_bearish.value
            )
            item_buy_logic.append(dataframe["ewo"] > self.ewo_high.value)
            item_buy_logic.append(dataframe["rsi14"] < self.rsi_buy_bearish.value)
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_37"] = 1
            conditions.append(item_buy)

        # Buy Condition #38
        dataframe.loc[:, "buy_condition_38"] = 0
        # Quick mode buy
        # -----------------------------------------------------------------------------------------
        if self.buy_params["buy_condition_38_enable"]:
            ...
            item_buy_logic.append(dataframe["volume"] > 0)
            item_buy = reduce(lambda x, y: x & y, item_buy_logic)
            dataframe.loc[item_buy, "buy_condition_38"] = 1
            conditions.append(item_buy)
...
def PMAX(df, period, multiplier, length, MAtype, src):
    ...
    for i in range(period, len(df)):
        final_ub[i] = (
            basic_ub[i]
            if (basic_ub[i] < final_ub[i - 1] or mavalues[i - 1] > final_ub[i - 1])
            else final_ub[i - 1]
        )
        final_lb[i] = (
            basic_lb[i]
            if (basic_lb[i] > final_lb[i - 1] or mavalues[i - 1] < final_lb[i - 1])
            else final_lb[i - 1]
        )
    ...
    for i in range(period, len(df)):
        pm_arr[i] = (
            final_ub[i]
            if (pm_arr[i - 1] == final_ub[i - 1] and mavalues[i] <= final_ub[i])
            else final_lb[i]
            if (pm_arr[i - 1] == final_ub[i - 1] and mavalues[i] > final_ub[i])
            else final_lb[i]
            if (pm_arr[i - 1] == final_lb[i - 1] and mavalues[i] >= final_lb[i])
            else final_ub[i]
            if (pm_arr[i - 1] == final_lb[i - 1] and mavalues[i] < final_lb[i])
            else 0.00
        )
    ...
    df[pmx] = np.where(
        (df[pm] > 0.00), np.where((df[mavalue] < df[pm]), "down", "up"), np.NaN
    )
