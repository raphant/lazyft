...
class BinH3Infp(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        bollinger = ta.BBANDS(dataframe_1d, timeperiod=20, nbdevup=2.0, nbdevdn=2.0)
        dataframe_1d['bb_middle'] = bollinger['middleband']
        dataframe_1d['bb_lower'] = bollinger['lowerband']
        dataframe_1d['bb_upper'] = bollinger['upperband']
        dataframe = resampled_merge(dataframe, dataframe_1d, fill_na=True)
