...
|   Best |  54/500 |      402 |        0.22% |    0.00160612 BTC   (89.38%) |        637.5 m |    -5.02931 |

|      Pair |   Buys |   Avg Profit % |   Cum Profit % |   Tot Profit BTC |   Tot Profit % |   Avg Duration |   Wins |   Draws |   Losses |
|     TOTAL |    210 |           0.26 |          54.22 |       0.00097432 |          18.07 |        9:50:00 |     95 |      93 |       22 |
"""
...
class BBRSICCI5m(IStrategy):
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with buy column
        """
        # (qtpylib.crossed_above(dataframe['fastk'], 72)) |
        # (qtpylib.crossed_above(dataframe['fastd'], 74))
        dataframe.loc[
            (
                (dataframe['cci_one'] > 100)
                & (dataframe['cci_two'] > 100)
                & (dataframe['cmf'] > 0.50035)
                & (dataframe['rsi'] > 56.96)
            )
