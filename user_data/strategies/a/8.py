...
8.py
Buy Stop ROI
    49/100:    671 trades. Avg profit   0.72%. Total profit  0.04269302 BTC ( 481.38Σ%). Avg duration 886.9 min. Objective: -45.51499

Before trailing opt:
|      Pair |   Buys |   Avg Profit % |   Cum Profit % |   Tot Profit BTC |   Tot Profit % |     Avg Duration |   Wins |   Draws |   Losses |
|     TOTAL |    333 |           0.40 |         134.10 |       0.01189337 |           0.00 |         10:02:00 |    199 |     126 |        8 |
======================================================== SELL REASON STATS =========================================================
|        Sell Reason |   Sells |   Wins |   Draws |   Losses |   Avg Profit % |   Cum Profit % |   Tot Profit BTC |   Tot Profit % |
|--------------------+---------+--------+---------+----------+----------------+----------------+------------------+----------------|
|                roi |     231 |    105 |     126 |        0 |           0.42 |          96.53 |       0.0085616  |              0 |
| trailing_stop_loss |      97 |     94 |       0 |        3 |           0.74 |          71.77 |       0.00636493 |              0 |
|         force_sell |       4 |      0 |       0 |        4 |          -2.44 |          -9.77 |      -0.00086629 |             -0 |
|          stop_loss |       1 |      0 |       0 |        1 |         -24.43 |         -24.43 |      -0.00216687 |             -0 |
...
class BBRSICCI5m(IStrategy):
    ...
    # ROI table:
    minimal_roi = {"0": 0.08351, "13": 0.02867, "69": 0.01309, "126": 0}
