...
class NotAnotherSMAOffsetStrategyHOv3Mod(IStrategy):
    INTERFACE_VERSION = 2
    ...
    def informative_pairs(self):
        ...
        informative_pairs = [("BTC/USDT", self.info_timeframe)]
    ...
    def informative_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative = self.dp.get_pair_dataframe(
            pair="BTC/" + self.stake_currency, timeframe=self.info_timeframe
        )
        ...
        # )
        # informative["btc_hma_slow"] = qtpylib.hull_moving_average(
        #     dataframe['close'], window=26
        # )
        # SMA
        ...
        del informative["btc_ema_med_slow"]
        return informative
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative = self.informative_indicators(dataframe, metadata)
